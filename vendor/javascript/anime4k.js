/* Anime4K.js — WebGL port of Anime4K (https://github.com/monyone/Anime4K.js)
 * Copyright (c) monyone and Anime4K contributors (https://github.com/bloc97/Anime4K)
 * MIT License. Slim base bundle for StreamVault: VideoUpscaler + the 2x
 * profiles (balanced: Clamp/Restore CNN M/Upscale CNN x2 M; quality: VL
 * chain). The 4x GAN chain lives in anime4k-ultra.js, loaded only when the
 * viewer picks 4x. Rebuilt with esbuild from anime4k.js@1.1.3 (npm). */
var k=(d,e,u)=>{let t=d.createShader(e);return t?(d.shaderSource(t,u),d.compileShader(t),d.getShaderParameter(t,d.COMPILE_STATUS)?t:(console.warn(d.getShaderInfoLog(t)),d.deleteShader(t),null)):null},v=(d,e)=>k(d,d.VERTEX_SHADER,e),l=(d,e)=>k(d,d.FRAGMENT_SHADER,e),x=(d,e,u)=>{let t=d.createProgram();return t?(d.attachShader(t,e),d.attachShader(t,u),d.linkProgram(t),d.getProgramParameter(t,d.LINK_STATUS)?(d.deleteShader(e),d.deleteShader(u),t):(console.warn(d.getProgramInfoLog(t)),d.deleteProgram(t),null)):null},p=(d,e)=>{let u=d.createTexture();return u?(d.bindTexture(d.TEXTURE_2D,u),d.texParameteri(d.TEXTURE_2D,d.TEXTURE_WRAP_S,d.CLAMP_TO_EDGE),d.texParameteri(d.TEXTURE_2D,d.TEXTURE_WRAP_T,d.CLAMP_TO_EDGE),d.texParameteri(d.TEXTURE_2D,d.TEXTURE_MIN_FILTER,e),d.texParameteri(d.TEXTURE_2D,d.TEXTURE_MAG_FILTER,e),d.bindTexture(d.TEXTURE_2D,null),u):null},T=(d,e,u,t)=>{let a=d.getExtension("OES_texture_half_float");d.bindTexture(d.TEXTURE_2D,e),d.texImage2D(d.TEXTURE_2D,0,d.RGBA,u,t,0,d.RGBA,a?.HALF_FLOAT_OES??d.FLOAT,null),d.bindTexture(d.TEXTURE_2D,null)},s=(d,e,u,t,a)=>{let f=d.createBuffer();return f?(d.bindBuffer(d.ARRAY_BUFFER,f),d.bufferData(d.ARRAY_BUFFER,new Float32Array([e,u,t,u,e,a,e,a,t,u,t,a]),d.STATIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,null),f):null},c=(d,e,u)=>{d.bindBuffer(d.ARRAY_BUFFER,u),d.vertexAttribPointer(e,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,null)};var Z=`
...
`,F=class{gl;program;resolutionLocation;sourceTextureLocation;aPositionLocation;aTextureCoordLocation;texcoordBuffer;positionBuffer=null;cachedWidth=null;cachedHeight=null;constructor(e){this.gl=e,this.program=x(e,v(e,Z),l(e,q)),this.texcoordBuffer=s(e,0,0,1,1),this.resolutionLocation=e.getUniformLocation(this.program,"u_resolution"),this.sourceTextureLocation=e.getUniformLocation(this.program,"u_image"),this.aPositionLocation=e.getAttribLocation(this.program,"a_position"),e.enableVertexAttribArray(this.aPositionLocation),this.aTextureCoordLocation=e.getAttribLocation(this.program,"a_texture_coord"),e.enableVertexAttribArray(this.aTextureCoordLocation)}destroy(){let e=this.gl;this.texcoordBuffer!=null&&e.deleteBuffer(this.texcoordBuffer),this.positionBuffer!=null&&e.deleteBuffer(this.positionBuffer)}render(e,u,t){let a=this.gl,f=this.texcoordBuffer;if(!f)return;let{texture:r}=e;{a.viewport(0,0,u,t),a.bindFramebuffer(a.FRAMEBUFFER,null),a.activeTexture(a.TEXTURE0),a.bindTexture(a.TEXTURE_2D,r),a.useProgram(this.program),this.positionBuffer==null?this.positionBuffer=s(a,0,0,u,t):(this.cachedWidth!==u||this.cachedHeight!==t)&&(a.deleteBuffer(this.positionBuffer),this.positionBuffer=s(a,0,0,u,t));let m=this.positionBuffer;c(a,this.aPositionLocation,m),c(a,this.aTextureCoordLocation,f),a.uniform2f(this.resolutionLocation,u,t),a.uniform1i(this.sourceTextureLocation,0),a.drawArrays(a.TRIANGLES,0,6),this.cachedWidth=u,this.cachedHeight=t}}};var K=(d,e)=>e!=null?!1:typeof d?.requestVideoFrameCallback=="function",Y=(d,e,u)=>e?.requestVideoFrameCallback&&K(e,u)?e.requestVideoFrameCallback(d):requestAnimationFrame(d),j=(d,e,u)=>{if(e?.cancelVideoFrameCallback&&K(e,u)){e.cancelVideoFrameCallback(d);return}cancelAnimationFrame(d)},W=class d{video=null;canvas=null;gl=null;scale=null;config;textures=new Map;in_texture=null;native_texture=null;output_texture=null;framebuffer=null;programs=null;passthrough=null;upscaleHandler=this.upscale.bind(this);upscaleTimer=null;running=!1;upscaleTime=0;fps;supported;constructor(e,u){this.supported=d.isSupported(),this.config=e,this.fps=u}static isSupported(){let u=document.createElement("canvas").getContext("webgl");return!(!u||u.getExtension("OES_texture_float")==null||u.getExtension("OES_texture_float_linear")==null)}start(){this.running=!0,this.upscaleTime=0,this.upscale()}stop(){this.running=!1,this.upscaleTime=0,this.canvas&&(this.canvas.style.visibility="hidden"),this.upscaleTimer!=null&&(j(this.upscaleTimer,this.video??void 0,this.fps),this.upscaleTimer=null)}upscale(){if(!this.supported||!this.video||!this.canvas||!this.gl||!this.framebuffer||!this.programs||!this.passthrough||!this.running)return;this.adjustCanvasSize();let e=performance.now();if(!K(this.video,this.fps)&&(e-this.upscaleTime)*(this.fps??Number.POSITIVE_INFINITY)<1e3){this.upscaleTimer=Y(this.upscaleHandler,this.video,this.fps);return}this.upscaleTime=e;let u=this.gl,t=this.framebuffer,a=this.in_texture;if(!a)return;u.bindTexture(u.TEXTURE_2D,a),u.texImage2D(u.TEXTURE_2D,0,u.RGBA,u.RGBA,u.UNSIGNED_BYTE,this.video),u.bindTexture(u.TEXTURE_2D,null);let f=this.native_texture;if(!f)return;let r=this.output_texture;if(!r)return;let m=this.video.videoWidth,o=this.video.videoHeight,_=this.canvas.width,i=this.canvas.height;{let n=this.textures.get("NATIVE");(n==null||n.width!==m||n.height!==o)&&this.textures.set("NATIVE",{texture:f,width:m,height:o})}{let n=this.textures.get("OUTPUT");(n==null||n.width!==_||n.height!==i)&&this.textures.set("OUTPUT",{texture:r,width:_,height:i})}{let n=this.textures.get("MAIN");(n==null||n.width!==m||n.height!==o)&&this.textures.set("MAIN",{texture:a,width:m,height:o})}if(this.programs.forEach(n=>n.hook_MAIN(this.textures,t)),this.textures.has("MAIN")){let n=this.textures.get("MAIN");this.textures.set("PREKERNEL",n),this.textures.delete("MAIN"),this.programs.forEach(g=>g.hook_PREKERNEL(this.textures,t))}this.passthrough.render(this.textures.get("PREKERNEL"),_,i),u.flush(),this.canvas.style.visibility="visible",this.upscaleTimer=Y(this.upscaleHandler,this.video,this.fps)}attachVideo(e,u){if(this.video=e,this.canvas=u,this.gl=this.canvas.getContext("webgl",{premultipliedAlpha:!1,stencil:!1,depth:!1}),this.gl&&this.gl.getExtension("OES_texture_float")&&this.gl.getExtension("OES_texture_float_linear")&&this.gl.getExtension("EXT_color_buffer_half_float")){let t=this.gl;t.disable(t.DEPTH_TEST),t.disable(t.STENCIL_TEST),t.clearColor(0,0,0,0),t.clear(t.COLOR_BUFFER_BIT),this.framebuffer=t.createFramebuffer(),this.in_texture=p(t,t.LINEAR),this.native_texture=p(t,t.LINEAR),this.output_texture=p(t,t.LINEAR),this.programs=this.config.map(a=>new a(t)),this.scale=null,this.passthrough=new F(t),this.adjustCanvasSize()}else this.detachVideo()}detachVideo(){this.stop(),(this.programs??[]).forEach(e=>e.destroy()),this.passthrough?.destroy(),this.passthrough=null,this.gl?.deleteFramebuffer(this.framebuffer),this.gl?.deleteTexture(this.in_texture),this.gl?.deleteTexture(this.native_texture),this.gl?.deleteTexture(this.output_texture),this.in_texture=this.native_texture=this.output_texture=null,this.gl=null,this.framebuffer=null,this.canvas&&(this.canvas.style.visibility="hidden"),this.video=null,this.canvas=null}adjustCanvasSize(){if(!this.video||!this.canvas)return;if(this.scale==null){let t=1,a=1;for(let f of this.programs??[]){let[r,m]=f.magnification();t*=r,a*=m}this.scale=[t,a]}let e=this.video.videoWidth*this.scale[0],u=this.video.videoHeight*this.scale[1];(this.canvas.width!==e||this.canvas.height!==u)&&(this.canvas.width=e,this.canvas.height=u),this.canvas.style.pointerEvents="none"}};var M=class{magnification(){return[1,1]}hook_MAIN(e,u){}hook_PREKERNEL(e,u){}};var C=`
precision highp float;
...
`,y=class extends M{gl;texcoordBuffer;program_0;program_1;program_2;program_0_intermediate_texture;program_1_intermediate_texture;program_2_intermediate_texture;program_0_intermediate_texture_cached_width;program_1_intermediate_texture_cached_width;program_2_intermediate_texture_cached_width;program_0_intermediate_texture_cached_height;program_1_intermediate_texture_cached_height;program_2_intermediate_texture_cached_height;program_0_a_position_location;program_1_a_position_location;program_2_a_position_location;program_0_a_texture_coord_location;program_1_a_texture_coord_location;program_2_a_texture_coord_location;program_0_u_resolution_location;program_1_u_resolution_location;program_2_u_resolution_location;program_0_u_texture_size_location;program_1_u_texture_size_location;program_2_u_texture_size_location;program_0_MAIN_TextureLocation;program_1_MAIN_TextureLocation;program_1_STATSMAX_TextureLocation;program_2_PREKERNEL_TextureLocation;program_2_STATSMAX_TextureLocation;program_0_position_buffer;program_1_position_buffer;program_2_position_buffer;constructor(e){super(),this.gl=e,this.texcoordBuffer=s(e,0,0,1,1),this.program_0=x(e,v(e,C),l(e,J)),this.program_1=x(e,v(e,C),l(e,Q)),this.program_2=x(e,v(e,C),l(e,$)),this.program_0_intermediate_texture=p(e,e.NEAREST),this.program_1_intermediate_texture=p(e,e.NEAREST),this.program_2_intermediate_texture=p(e,e.NEAREST),this.program_0_intermediate_texture_cached_width=null,this.program_1_intermediate_texture_cached_width=null,this.program_2_intermediate_texture_cached_width=null,this.program_0_intermediate_texture_cached_height=null,this.program_1_intermediate_texture_cached_height=null,this.program_2_intermediate_texture_cached_height=null,this.program_0_a_position_location=e.getAttribLocation(this.program_0,"a_position"),e.enableVertexAttribArray(this.program_0_a_position_location),this.program_1_a_position_location=e.getAttribLocation(this.program_1,"a_position"),e.enableVertexAttribArray(this.program_1_a_position_location),this.program_2_a_position_location=e.getAttribLocation(this.program_2,"a_position"),e.enableVertexAttribArray(this.program_2_a_position_location),this.program_0_a_texture_coord_location=e.getAttribLocation(this.program_0,"a_texture_coord"),e.enableVertexAttribArray(this.program_0_a_texture_coord_location),this.program_1_a_texture_coord_location=e.getAttribLocation(this.program_1,"a_texture_coord"),e.enableVertexAttribArray(this.program_1_a_texture_coord_location),this.program_2_a_texture_coord_location=e.getAttribLocation(this.program_2,"a_texture_coord"),e.enableVertexAttribArray(this.program_2_a_texture_coord_location),this.program_0_u_resolution_location=e.getUniformLocation(this.program_0,"u_resolution"),this.program_1_u_resolution_location=e.getUniformLocation(this.program_1,"u_resolution"),this.program_2_u_resolution_location=e.getUniformLocation(this.program_2,"u_resolution"),this.program_0_u_texture_size_location=e.getUniformLocation(this.program_0,"u_texture_size"),this.program_1_u_texture_size_location=e.getUniformLocation(this.program_1,"u_texture_size"),this.program_2_u_texture_size_location=e.getUniformLocation(this.program_2,"u_texture_size"),this.program_0_MAIN_TextureLocation=e.getUniformLocation(this.program_0,"MAIN"),this.program_1_MAIN_TextureLocation=e.getUniformLocation(this.program_1,"MAIN"),this.program_1_STATSMAX_TextureLocation=e.getUniformLocation(this.program_1,"STATSMAX"),this.program_2_PREKERNEL_TextureLocation=e.getUniformLocation(this.program_2,"PREKERNEL"),this.program_2_STATSMAX_TextureLocation=e.getUniformLocation(this.program_2,"STATSMAX"),this.program_0_position_buffer=null,this.program_1_position_buffer=null,this.program_2_position_buffer=null}destroy(){let e=this.gl;this.texcoordBuffer!=null&&e.deleteBuffer(this.texcoordBuffer),this.program_0_intermediate_texture!=null&&e.deleteTexture(this.program_0_intermediate_texture),this.program_0_position_buffer!=null&&e.deleteBuffer(this.program_0_position_buffer),this.program_0!=null&&e.deleteProgram(this.program_0),this.program_1_intermediate_texture!=null&&e.deleteTexture(this.program_1_intermediate_texture),this.program_1_position_buffer!=null&&e.deleteBuffer(this.program_1_position_buffer),this.program_1!=null&&e.deleteProgram(this.program_1),this.program_2_intermediate_texture!=null&&e.deleteTexture(this.program_2_intermediate_texture),this.program_2_position_buffer!=null&&e.deleteBuffer(this.program_2_position_buffer),this.program_2!=null&&e.deleteProgram(this.program_2)}magnification(){let e=new Map([["MAIN",{width:1,height:1}],["NATIVE",{width:1,height:1}],["OUTPUT",{width:1,height:1}]]);{if(!e.get("MAIN"))return[1,1];let f=e.get("MAIN");if(!f)return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];e.set("STATSMAX",{width:f.width,height:f.height})}{if(!e.get("MAIN"))return[1,1];let f=e.get("MAIN");if(!f)return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];if(!e.get("STATSMAX"))return[1,1];e.set("STATSMAX",{width:f.width,height:f.height})}let u=e.get("MAIN")?.width??1,t=e.get("MAIN")?.height??1;return[u,t]}hook_MAIN(e,u){let t=this.gl,a=this.texcoordBuffer;if(a){{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;{let _=this.program_0_intermediate_texture;(this.program_0_intermediate_texture_cached_width!==r.width||this.program_0_intermediate_texture_cached_height!==r.height)&&T(t,_,r.width,r.height),t.viewport(0,0,r.width,r.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,_,0),t.useProgram(this.program_0),this.program_0_position_buffer==null?this.program_0_position_buffer=s(t,0,0,r.width,r.height):(this.program_0_intermediate_texture_cached_width!==r.width||this.program_0_intermediate_texture_cached_height!==r.height)&&(t.deleteBuffer(this.program_0_position_buffer),this.program_0_position_buffer=s(t,0,0,r.width,r.height));let i=this.program_0_position_buffer;c(t,this.program_0_a_position_location,i),c(t,this.program_0_a_texture_coord_location,a),t.uniform2f(this.program_0_u_resolution_location,r.width,r.height),t.uniform2f(this.program_0_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_0_MAIN_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_0_intermediate_texture_cached_width=r.width,this.program_0_intermediate_texture_cached_height=r.height,e.set("STATSMAX",{texture:_,width:r.width,height:r.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("STATSMAX");if(!_)return;{let i=this.program_1_intermediate_texture;(this.program_1_intermediate_texture_cached_width!==r.width||this.program_1_intermediate_texture_cached_height!==r.height)&&T(t,i,r.width,r.height),t.viewport(0,0,r.width,r.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,i,0),t.useProgram(this.program_1),this.program_1_position_buffer==null?this.program_1_position_buffer=s(t,0,0,r.width,r.height):(this.program_1_intermediate_texture_cached_width!==r.width||this.program_1_intermediate_texture_cached_height!==r.height)&&(t.deleteBuffer(this.program_1_position_buffer),this.program_1_position_buffer=s(t,0,0,r.width,r.height));let n=this.program_1_position_buffer;c(t,this.program_1_a_position_location,n),c(t,this.program_1_a_texture_coord_location,a),t.uniform2f(this.program_1_u_resolution_location,r.width,r.height),t.uniform2f(this.program_1_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_1_MAIN_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_1_STATSMAX_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_1_intermediate_texture_cached_width=r.width,this.program_1_intermediate_texture_cached_height=r.height,e.set("STATSMAX",{texture:i,width:r.width,height:r.height})}}}}hook_PREKERNEL(e,u){let t=this.gl,a=this.texcoordBuffer;if(a){if(!e.get("PREKERNEL")||!e.get("NATIVE")||!e.get("OUTPUT"))return;let o=e.get("PREKERNEL");if(!o)return;let _=e.get("STATSMAX");if(!_)return;{let i=this.program_2_intermediate_texture;(this.program_2_intermediate_texture_cached_width!==o.width||this.program_2_intermediate_texture_cached_height!==o.height)&&T(t,i,o.width,o.height),t.viewport(0,0,o.width,o.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,i,0),t.useProgram(this.program_2),this.program_2_position_buffer==null?this.program_2_position_buffer=s(t,0,0,o.width,o.height):(this.program_2_intermediate_texture_cached_width!==o.width||this.program_2_intermediate_texture_cached_height!==o.height)&&(t.deleteBuffer(this.program_2_position_buffer),this.program_2_position_buffer=s(t,0,0,o.width,o.height));let n=this.program_2_position_buffer;c(t,this.program_2_a_position_location,n),c(t,this.program_2_a_texture_coord_location,a),t.uniform2f(this.program_2_u_resolution_location,o.width,o.height),t.uniform2f(this.program_2_u_texture_size_location,o.width,o.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,o.texture),t.uniform1i(this.program_2_PREKERNEL_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_2_STATSMAX_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_2_intermediate_texture_cached_width=o.width,this.program_2_intermediate_texture_cached_height=o.height,e.set("PREKERNEL",{texture:i,width:o.width,height:o.height})}}}};var G=`
precision highp float;
...
`,B=class extends M{gl;texcoordBuffer;program_0;program_1;program_2;program_3;program_4;program_5;program_6;program_7;program_8;program_9;program_10;program_11;program_12;program_13;program_14;program_15;program_16;program_0_intermediate_texture;program_1_intermediate_texture;program_2_intermediate_texture;program_3_intermediate_texture;program_4_intermediate_texture;program_5_intermediate_texture;program_6_intermediate_texture;program_7_intermediate_texture;program_8_intermediate_texture;program_9_intermediate_texture;program_10_intermediate_texture;program_11_intermediate_texture;program_12_intermediate_texture;program_13_intermediate_texture;program_14_intermediate_texture;program_15_intermediate_texture;program_16_intermediate_texture;program_0_intermediate_texture_cached_width;program_1_intermediate_texture_cached_width;program_2_intermediate_texture_cached_width;program_3_intermediate_texture_cached_width;program_4_intermediate_texture_cached_width;program_5_intermediate_texture_cached_width;program_6_intermediate_texture_cached_width;program_7_intermediate_texture_cached_width;program_8_intermediate_texture_cached_width;program_9_intermediate_texture_cached_width;program_10_intermediate_texture_cached_width;program_11_intermediate_texture_cached_width;program_12_intermediate_texture_cached_width;program_13_intermediate_texture_cached_width;program_14_intermediate_texture_cached_width;program_15_intermediate_texture_cached_width;program_16_intermediate_texture_cached_width;program_0_intermediate_texture_cached_height;program_1_intermediate_texture_cached_height;program_2_intermediate_texture_cached_height;program_3_intermediate_texture_cached_height;program_4_intermediate_texture_cached_height;program_5_intermediate_texture_cached_height;program_6_intermediate_texture_cached_height;program_7_intermediate_texture_cached_height;program_8_intermediate_texture_cached_height;program_9_intermediate_texture_cached_height;program_10_intermediate_texture_cached_height;program_11_intermediate_texture_cached_height;program_12_intermediate_texture_cached_height;program_13_intermediate_texture_cached_height;program_14_intermediate_texture_cached_height;program_15_intermediate_texture_cached_height;program_16_intermediate_texture_cached_height;program_0_a_position_location;program_1_a_position_location;program_2_a_position_location;program_3_a_position_location;program_4_a_position_location;program_5_a_position_location;program_6_a_position_location;program_7_a_position_location;program_8_a_position_location;program_9_a_position_location;program_10_a_position_location;program_11_a_position_location;program_12_a_position_location;program_13_a_position_location;program_14_a_position_location;program_15_a_position_location;program_16_a_position_location;program_0_a_texture_coord_location;program_1_a_texture_coord_location;program_2_a_texture_coord_location;program_3_a_texture_coord_location;program_4_a_texture_coord_location;program_5_a_texture_coord_location;program_6_a_texture_coord_location;program_7_a_texture_coord_location;program_8_a_texture_coord_location;program_9_a_texture_coord_location;program_10_a_texture_coord_location;program_11_a_texture_coord_location;program_12_a_texture_coord_location;program_13_a_texture_coord_location;program_14_a_texture_coord_location;program_15_a_texture_coord_location;program_16_a_texture_coord_location;program_0_u_resolution_location;program_1_u_resolution_location;program_2_u_resolution_location;program_3_u_resolution_location;program_4_u_resolution_location;program_5_u_resolution_location;program_6_u_resolution_location;program_7_u_resolution_location;program_8_u_resolution_location;program_9_u_resolution_location;program_10_u_resolution_location;program_11_u_resolution_location;program_12_u_resolution_location;program_13_u_resolution_location;program_14_u_resolution_location;program_15_u_resolution_location;program_16_u_resolution_location;program_0_u_texture_size_location;program_1_u_texture_size_location;program_2_u_texture_size_location;program_3_u_texture_size_location;program_4_u_texture_size_location;program_5_u_texture_size_location;program_6_u_texture_size_location;program_7_u_texture_size_location;program_8_u_texture_size_location;program_9_u_texture_size_location;program_10_u_texture_size_location;program_11_u_texture_size_location;program_12_u_texture_size_location;program_13_u_texture_size_location;program_14_u_texture_size_location;program_15_u_texture_size_location;program_16_u_texture_size_location;program_0_MAIN_TextureLocation;program_1_MAIN_TextureLocation;program_2_conv2d_tf_TextureLocation;program_2_conv2d_tf1_TextureLocation;program_3_conv2d_tf_TextureLocation;program_3_conv2d_tf1_TextureLocation;program_4_conv2d_1_tf_TextureLocation;program_4_conv2d_1_tf1_TextureLocation;program_5_conv2d_1_tf_TextureLocation;program_5_conv2d_1_tf1_TextureLocation;program_6_conv2d_2_tf_TextureLocation;program_6_conv2d_2_tf1_TextureLocation;program_7_conv2d_2_tf_TextureLocation;program_7_conv2d_2_tf1_TextureLocation;program_8_conv2d_3_tf_TextureLocation;program_8_conv2d_3_tf1_TextureLocation;program_9_conv2d_3_tf_TextureLocation;program_9_conv2d_3_tf1_TextureLocation;program_10_conv2d_4_tf_TextureLocation;program_10_conv2d_4_tf1_TextureLocation;program_11_conv2d_4_tf_TextureLocation;program_11_conv2d_4_tf1_TextureLocation;program_12_conv2d_5_tf_TextureLocation;program_12_conv2d_5_tf1_TextureLocation;program_13_conv2d_5_tf_TextureLocation;program_13_conv2d_5_tf1_TextureLocation;program_14_conv2d_6_tf_TextureLocation;program_14_conv2d_6_tf1_TextureLocation;program_15_conv2d_6_tf_TextureLocation;program_15_conv2d_6_tf1_TextureLocation;program_16_MAIN_TextureLocation;program_16_conv2d_1_tf_TextureLocation;program_16_conv2d_1_tf1_TextureLocation;program_16_conv2d_2_tf_TextureLocation;program_16_conv2d_2_tf1_TextureLocation;program_16_conv2d_3_tf_TextureLocation;program_16_conv2d_3_tf1_TextureLocation;program_16_conv2d_4_tf_TextureLocation;program_16_conv2d_4_tf1_TextureLocation;program_16_conv2d_5_tf_TextureLocation;program_16_conv2d_5_tf1_TextureLocation;program_16_conv2d_6_tf_TextureLocation;program_16_conv2d_6_tf1_TextureLocation;program_16_conv2d_7_tf_TextureLocation;program_16_conv2d_7_tf1_TextureLocation;program_0_position_buffer;program_1_position_buffer;program_2_position_buffer;program_3_position_buffer;program_4_position_buffer;program_5_position_buffer;program_6_position_buffer;program_7_position_buffer;program_8_position_buffer;program_9_position_buffer;program_10_position_buffer;program_11_position_buffer;program_12_position_buffer;program_13_position_buffer;program_14_position_buffer;program_15_position_buffer;program_16_position_buffer;constructor(e){super(),this.gl=e,this.texcoordBuffer=s(e,0,0,1,1),this.program_0=x(e,v(e,w),l(e,f0)),this.program_1=x(e,v(e,w),l(e,u0)),this.program_2=x(e,v(e,w),l(e,s0)),this.program_3=x(e,v(e,w),l(e,c0)),this.program_4=x(e,v(e,w),l(e,m0)),this.program_5=x(e,v(e,w),l(e,d0)),this.program_6=x(e,v(e,w),l(e,g0)),this.program_7=x(e,v(e,w),l(e,h0)),this.program_8=x(e,v(e,w),l(e,p0)),this.program_9=x(e,v(e,w),l(e,v0)),this.program_10=x(e,v(e,w),l(e,l0)),this.program_11=x(e,v(e,w),l(e,x0)),this.program_12=x(e,v(e,w),l(e,T0)),this.program_13=x(e,v(e,w),l(e,b0)),this.program_14=x(e,v(e,w),l(e,E0)),this.program_15=x(e,v(e,w),l(e,U0)),this.program_16=x(e,v(e,w),l(e,A0)),this.program_0_intermediate_texture=p(e,e.NEAREST),this.program_1_intermediate_texture=p(e,e.NEAREST),this.program_2_intermediate_texture=p(e,e.NEAREST),this.program_3_intermediate_texture=p(e,e.NEAREST),this.program_4_intermediate_texture=p(e,e.NEAREST),this.program_5_intermediate_texture=p(e,e.NEAREST),this.program_6_intermediate_texture=p(e,e.NEAREST),this.program_7_intermediate_texture=p(e,e.NEAREST),this.program_8_intermediate_texture=p(e,e.NEAREST),this.program_9_intermediate_texture=p(e,e.NEAREST),this.program_10_intermediate_texture=p(e,e.NEAREST),this.program_11_intermediate_texture=p(e,e.NEAREST),this.program_12_intermediate_texture=p(e,e.NEAREST),this.program_13_intermediate_texture=p(e,e.NEAREST),this.program_14_intermediate_texture=p(e,e.NEAREST),this.program_15_intermediate_texture=p(e,e.NEAREST),this.program_16_intermediate_texture=p(e,e.NEAREST),this.program_0_intermediate_texture_cached_width=null,this.program_1_intermediate_texture_cached_width=null,this.program_2_intermediate_texture_cached_width=null,this.program_3_intermediate_texture_cached_width=null,this.program_4_intermediate_texture_cached_width=null,this.program_5_intermediate_texture_cached_width=null,this.program_6_intermediate_texture_cached_width=null,this.program_7_intermediate_texture_cached_width=null,this.program_8_intermediate_texture_cached_width=null,this.program_9_intermediate_texture_cached_width=null,this.program_10_intermediate_texture_cached_width=null,this.program_11_intermediate_texture_cached_width=null,this.program_12_intermediate_texture_cached_width=null,this.program_13_intermediate_texture_cached_width=null,this.program_14_intermediate_texture_cached_width=null,this.program_15_intermediate_texture_cached_width=null,this.program_16_intermediate_texture_cached_width=null,this.program_0_intermediate_texture_cached_height=null,this.program_1_intermediate_texture_cached_height=null,this.program_2_intermediate_texture_cached_height=null,this.program_3_intermediate_texture_cached_height=null,this.program_4_intermediate_texture_cached_height=null,this.program_5_intermediate_texture_cached_height=null,this.program_6_intermediate_texture_cached_height=null,this.program_7_intermediate_texture_cached_height=null,this.program_8_intermediate_texture_cached_height=null,this.program_9_intermediate_texture_cached_height=null,this.program_10_intermediate_texture_cached_height=null,this.program_11_intermediate_texture_cached_height=null,this.program_12_intermediate_texture_cached_height=null,this.program_13_intermediate_texture_cached_height=null,this.program_14_intermediate_texture_cached_height=null,this.program_15_intermediate_texture_cached_height=null,this.program_16_intermediate_texture_cached_height=null,this.program_0_a_position_location=e.getAttribLocation(this.program_0,"a_position"),e.enableVertexAttribArray(this.program_0_a_position_location),this.program_1_a_position_location=e.getAttribLocation(this.program_1,"a_position"),e.enableVertexAttribArray(this.program_1_a_position_location),this.program_2_a_position_location=e.getAttribLocation(this.program_2,"a_position"),e.enableVertexAttribArray(this.program_2_a_position_location),this.program_3_a_position_location=e.getAttribLocation(this.program_3,"a_position"),e.enableVertexAttribArray(this.program_3_a_position_location),this.program_4_a_position_location=e.getAttribLocation(this.program_4,"a_position"),e.enableVertexAttribArray(this.program_4_a_position_location),this.program_5_a_position_location=e.getAttribLocation(this.program_5,"a_position"),e.enableVertexAttribArray(this.program_5_a_position_location),this.program_6_a_position_location=e.getAttribLocation(this.program_6,"a_position"),e.enableVertexAttribArray(this.program_6_a_position_location),this.program_7_a_position_location=e.getAttribLocation(this.program_7,"a_position"),e.enableVertexAttribArray(this.program_7_a_position_location),this.program_8_a_position_location=e.getAttribLocation(this.program_8,"a_position"),e.enableVertexAttribArray(this.program_8_a_position_location),this.program_9_a_position_location=e.getAttribLocation(this.program_9,"a_position"),e.enableVertexAttribArray(this.program_9_a_position_location),this.program_10_a_position_location=e.getAttribLocation(this.program_10,"a_position"),e.enableVertexAttribArray(this.program_10_a_position_location),this.program_11_a_position_location=e.getAttribLocation(this.program_11,"a_position"),e.enableVertexAttribArray(this.program_11_a_position_location),this.program_12_a_position_location=e.getAttribLocation(this.program_12,"a_position"),e.enableVertexAttribArray(this.program_12_a_position_location),this.program_13_a_position_location=e.getAttribLocation(this.program_13,"a_position"),e.enableVertexAttribArray(this.program_13_a_position_location),this.program_14_a_position_location=e.getAttribLocation(this.program_14,"a_position"),e.enableVertexAttribArray(this.program_14_a_position_location),this.program_15_a_position_location=e.getAttribLocation(this.program_15,"a_position"),e.enableVertexAttribArray(this.program_15_a_position_location),this.program_16_a_position_location=e.getAttribLocation(this.program_16,"a_position"),e.enableVertexAttribArray(this.program_16_a_position_location),this.program_0_a_texture_coord_location=e.getAttribLocation(this.program_0,"a_texture_coord"),e.enableVertexAttribArray(this.program_0_a_texture_coord_location),this.program_1_a_texture_coord_location=e.getAttribLocation(this.program_1,"a_texture_coord"),e.enableVertexAttribArray(this.program_1_a_texture_coord_location),this.program_2_a_texture_coord_location=e.getAttribLocation(this.program_2,"a_texture_coord"),e.enableVertexAttribArray(this.program_2_a_texture_coord_location),this.program_3_a_texture_coord_location=e.getAttribLocation(this.program_3,"a_texture_coord"),e.enableVertexAttribArray(this.program_3_a_texture_coord_location),this.program_4_a_texture_coord_location=e.getAttribLocation(this.program_4,"a_texture_coord"),e.enableVertexAttribArray(this.program_4_a_texture_coord_location),this.program_5_a_texture_coord_location=e.getAttribLocation(this.program_5,"a_texture_coord"),e.enableVertexAttribArray(this.program_5_a_texture_coord_location),this.program_6_a_texture_coord_location=e.getAttribLocation(this.program_6,"a_texture_coord"),e.enableVertexAttribArray(this.program_6_a_texture_coord_location),this.program_7_a_texture_coord_location=e.getAttribLocation(this.program_7,"a_texture_coord"),e.enableVertexAttribArray(this.program_7_a_texture_coord_location),this.program_8_a_texture_coord_location=e.getAttribLocation(this.program_8,"a_texture_coord"),e.enableVertexAttribArray(this.program_8_a_texture_coord_location),this.program_9_a_texture_coord_location=e.getAttribLocation(this.program_9,"a_texture_coord"),e.enableVertexAttribArray(this.program_9_a_texture_coord_location),this.program_10_a_texture_coord_location=e.getAttribLocation(this.program_10,"a_texture_coord"),e.enableVertexAttribArray(this.program_10_a_texture_coord_location),this.program_11_a_texture_coord_location=e.getAttribLocation(this.program_11,"a_texture_coord"),e.enableVertexAttribArray(this.program_11_a_texture_coord_location),this.program_12_a_texture_coord_location=e.getAttribLocation(this.program_12,"a_texture_coord"),e.enableVertexAttribArray(this.program_12_a_texture_coord_location),this.program_13_a_texture_coord_location=e.getAttribLocation(this.program_13,"a_texture_coord"),e.enableVertexAttribArray(this.program_13_a_texture_coord_location),this.program_14_a_texture_coord_location=e.getAttribLocation(this.program_14,"a_texture_coord"),e.enableVertexAttribArray(this.program_14_a_texture_coord_location),this.program_15_a_texture_coord_location=e.getAttribLocation(this.program_15,"a_texture_coord"),e.enableVertexAttribArray(this.program_15_a_texture_coord_location),this.program_16_a_texture_coord_location=e.getAttribLocation(this.program_16,"a_texture_coord"),e.enableVertexAttribArray(this.program_16_a_texture_coord_location),this.program_0_u_resolution_location=e.getUniformLocation(this.program_0,"u_resolution"),this.program_1_u_resolution_location=e.getUniformLocation(this.program_1,"u_resolution"),this.program_2_u_resolution_location=e.getUniformLocation(this.program_2,"u_resolution"),this.program_3_u_resolution_location=e.getUniformLocation(this.program_3,"u_resolution"),this.program_4_u_resolution_location=e.getUniformLocation(this.program_4,"u_resolution"),this.program_5_u_resolution_location=e.getUniformLocation(this.program_5,"u_resolution"),this.program_6_u_resolution_location=e.getUniformLocation(this.program_6,"u_resolution"),this.program_7_u_resolution_location=e.getUniformLocation(this.program_7,"u_resolution"),this.program_8_u_resolution_location=e.getUniformLocation(this.program_8,"u_resolution"),this.program_9_u_resolution_location=e.getUniformLocation(this.program_9,"u_resolution"),this.program_10_u_resolution_location=e.getUniformLocation(this.program_10,"u_resolution"),this.program_11_u_resolution_location=e.getUniformLocation(this.program_11,"u_resolution"),this.program_12_u_resolution_location=e.getUniformLocation(this.program_12,"u_resolution"),this.program_13_u_resolution_location=e.getUniformLocation(this.program_13,"u_resolution"),this.program_14_u_resolution_location=e.getUniformLocation(this.program_14,"u_resolution"),this.program_15_u_resolution_location=e.getUniformLocation(this.program_15,"u_resolution"),this.program_16_u_resolution_location=e.getUniformLocation(this.program_16,"u_resolution"),this.program_0_u_texture_size_location=e.getUniformLocation(this.program_0,"u_texture_size"),this.program_1_u_texture_size_location=e.getUniformLocation(this.program_1,"u_texture_size"),this.program_2_u_texture_size_location=e.getUniformLocation(this.program_2,"u_texture_size"),this.program_3_u_texture_size_location=e.getUniformLocation(this.program_3,"u_texture_size"),this.program_4_u_texture_size_location=e.getUniformLocation(this.program_4,"u_texture_size"),this.program_5_u_texture_size_location=e.getUniformLocation(this.program_5,"u_texture_size"),this.program_6_u_texture_size_location=e.getUniformLocation(this.program_6,"u_texture_size"),this.program_7_u_texture_size_location=e.getUniformLocation(this.program_7,"u_texture_size"),this.program_8_u_texture_size_location=e.getUniformLocation(this.program_8,"u_texture_size"),this.program_9_u_texture_size_location=e.getUniformLocation(this.program_9,"u_texture_size"),this.program_10_u_texture_size_location=e.getUniformLocation(this.program_10,"u_texture_size"),this.program_11_u_texture_size_location=e.getUniformLocation(this.program_11,"u_texture_size"),this.program_12_u_texture_size_location=e.getUniformLocation(this.program_12,"u_texture_size"),this.program_13_u_texture_size_location=e.getUniformLocation(this.program_13,"u_texture_size"),this.program_14_u_texture_size_location=e.getUniformLocation(this.program_14,"u_texture_size"),this.program_15_u_texture_size_location=e.getUniformLocation(this.program_15,"u_texture_size"),this.program_16_u_texture_size_location=e.getUniformLocation(this.program_16,"u_texture_size"),this.program_0_MAIN_TextureLocation=e.getUniformLocation(this.program_0,"MAIN"),this.program_1_MAIN_TextureLocation=e.getUniformLocation(this.program_1,"MAIN"),this.program_2_conv2d_tf_TextureLocation=e.getUniformLocation(this.program_2,"conv2d_tf"),this.program_2_conv2d_tf1_TextureLocation=e.getUniformLocation(this.program_2,"conv2d_tf1"),this.program_3_conv2d_tf_TextureLocation=e.getUniformLocation(this.program_3,"conv2d_tf"),this.program_3_conv2d_tf1_TextureLocation=e.getUniformLocation(this.program_3,"conv2d_tf1"),this.program_4_conv2d_1_tf_TextureLocation=e.getUniformLocation(this.program_4,"conv2d_1_tf"),this.program_4_conv2d_1_tf1_TextureLocation=e.getUniformLocation(this.program_4,"conv2d_1_tf1"),this.program_5_conv2d_1_tf_TextureLocation=e.getUniformLocation(this.program_5,"conv2d_1_tf"),this.program_5_conv2d_1_tf1_TextureLocation=e.getUniformLocation(this.program_5,"conv2d_1_tf1"),this.program_6_conv2d_2_tf_TextureLocation=e.getUniformLocation(this.program_6,"conv2d_2_tf"),this.program_6_conv2d_2_tf1_TextureLocation=e.getUniformLocation(this.program_6,"conv2d_2_tf1"),this.program_7_conv2d_2_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_2_tf"),this.program_7_conv2d_2_tf1_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_2_tf1"),this.program_8_conv2d_3_tf_TextureLocation=e.getUniformLocation(this.program_8,"conv2d_3_tf"),this.program_8_conv2d_3_tf1_TextureLocation=e.getUniformLocation(this.program_8,"conv2d_3_tf1"),this.program_9_conv2d_3_tf_TextureLocation=e.getUniformLocation(this.program_9,"conv2d_3_tf"),this.program_9_conv2d_3_tf1_TextureLocation=e.getUniformLocation(this.program_9,"conv2d_3_tf1"),this.program_10_conv2d_4_tf_TextureLocation=e.getUniformLocation(this.program_10,"conv2d_4_tf"),this.program_10_conv2d_4_tf1_TextureLocation=e.getUniformLocation(this.program_10,"conv2d_4_tf1"),this.program_11_conv2d_4_tf_TextureLocation=e.getUniformLocation(this.program_11,"conv2d_4_tf"),this.program_11_conv2d_4_tf1_TextureLocation=e.getUniformLocation(this.program_11,"conv2d_4_tf1"),this.program_12_conv2d_5_tf_TextureLocation=e.getUniformLocation(this.program_12,"conv2d_5_tf"),this.program_12_conv2d_5_tf1_TextureLocation=e.getUniformLocation(this.program_12,"conv2d_5_tf1"),this.program_13_conv2d_5_tf_TextureLocation=e.getUniformLocation(this.program_13,"conv2d_5_tf"),this.program_13_conv2d_5_tf1_TextureLocation=e.getUniformLocation(this.program_13,"conv2d_5_tf1"),this.program_14_conv2d_6_tf_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_6_tf"),this.program_14_conv2d_6_tf1_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_6_tf1"),this.program_15_conv2d_6_tf_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_6_tf"),this.program_15_conv2d_6_tf1_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_6_tf1"),this.program_16_MAIN_TextureLocation=e.getUniformLocation(this.program_16,"MAIN"),this.program_16_conv2d_1_tf_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_1_tf"),this.program_16_conv2d_1_tf1_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_1_tf1"),this.program_16_conv2d_2_tf_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_2_tf"),this.program_16_conv2d_2_tf1_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_2_tf1"),this.program_16_conv2d_3_tf_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_3_tf"),this.program_16_conv2d_3_tf1_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_3_tf1"),this.program_16_conv2d_4_tf_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_4_tf"),this.program_16_conv2d_4_tf1_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_4_tf1"),this.program_16_conv2d_5_tf_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_5_tf"),this.program_16_conv2d_5_tf1_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_5_tf1"),this.program_16_conv2d_6_tf_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_6_tf"),this.program_16_conv2d_6_tf1_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_6_tf1"),this.program_16_conv2d_7_tf_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_7_tf"),this.program_16_conv2d_7_tf1_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_7_tf1"),this.program_0_position_buffer=null,this.program_1_position_buffer=null,this.program_2_position_buffer=null,this.program_3_position_buffer=null,this.program_4_position_buffer=null,this.program_5_position_buffer=null,this.program_6_position_buffer=null,this.program_7_position_buffer=null,this.program_8_position_buffer=null,this.program_9_position_buffer=null,this.program_10_position_buffer=null,this.program_11_position_buffer=null,this.program_12_position_buffer=null,this.program_13_position_buffer=null,this.program_14_position_buffer=null,this.program_15_position_buffer=null,this.program_16_position_buffer=null}destroy(){let e=this.gl;this.texcoordBuffer!=null&&e.deleteBuffer(this.texcoordBuffer),this.program_0_intermediate_texture!=null&&e.deleteTexture(this.program_0_intermediate_texture),this.program_0_position_buffer!=null&&e.deleteBuffer(this.program_0_position_buffer),this.program_0!=null&&e.deleteProgram(this.program_0),this.program_1_intermediate_texture!=null&&e.deleteTexture(this.program_1_intermediate_texture),this.program_1_position_buffer!=null&&e.deleteBuffer(this.program_1_position_buffer),this.program_1!=null&&e.deleteProgram(this.program_1),this.program_2_intermediate_texture!=null&&e.deleteTexture(this.program_2_intermediate_texture),this.program_2_position_buffer!=null&&e.deleteBuffer(this.program_2_position_buffer),this.program_2!=null&&e.deleteProgram(this.program_2),this.program_3_intermediate_texture!=null&&e.deleteTexture(this.program_3_intermediate_texture),this.program_3_position_buffer!=null&&e.deleteBuffer(this.program_3_position_buffer),this.program_3!=null&&e.deleteProgram(this.program_3),this.program_4_intermediate_texture!=null&&e.deleteTexture(this.program_4_intermediate_texture),this.program_4_position_buffer!=null&&e.deleteBuffer(this.program_4_position_buffer),this.program_4!=null&&e.deleteProgram(this.program_4),this.program_5_intermediate_texture!=null&&e.deleteTexture(this.program_5_intermediate_texture),this.program_5_position_buffer!=null&&e.deleteBuffer(this.program_5_position_buffer),this.program_5!=null&&e.deleteProgram(this.program_5),this.program_6_intermediate_texture!=null&&e.deleteTexture(this.program_6_intermediate_texture),this.program_6_position_buffer!=null&&e.deleteBuffer(this.program_6_position_buffer),this.program_6!=null&&e.deleteProgram(this.program_6),this.program_7_intermediate_texture!=null&&e.deleteTexture(this.program_7_intermediate_texture),this.program_7_position_buffer!=null&&e.deleteBuffer(this.program_7_position_buffer),this.program_7!=null&&e.deleteProgram(this.program_7),this.program_8_intermediate_texture!=null&&e.deleteTexture(this.program_8_intermediate_texture),this.program_8_position_buffer!=null&&e.deleteBuffer(this.program_8_position_buffer),this.program_8!=null&&e.deleteProgram(this.program_8),this.program_9_intermediate_texture!=null&&e.deleteTexture(this.program_9_intermediate_texture),this.program_9_position_buffer!=null&&e.deleteBuffer(this.program_9_position_buffer),this.program_9!=null&&e.deleteProgram(this.program_9),this.program_10_intermediate_texture!=null&&e.deleteTexture(this.program_10_intermediate_texture),this.program_10_position_buffer!=null&&e.deleteBuffer(this.program_10_position_buffer),this.program_10!=null&&e.deleteProgram(this.program_10),this.program_11_intermediate_texture!=null&&e.deleteTexture(this.program_11_intermediate_texture),this.program_11_position_buffer!=null&&e.deleteBuffer(this.program_11_position_buffer),this.program_11!=null&&e.deleteProgram(this.program_11),this.program_12_intermediate_texture!=null&&e.deleteTexture(this.program_12_intermediate_texture),this.program_12_position_buffer!=null&&e.deleteBuffer(this.program_12_position_buffer),this.program_12!=null&&e.deleteProgram(this.program_12),this.program_13_intermediate_texture!=null&&e.deleteTexture(this.program_13_intermediate_texture),this.program_13_position_buffer!=null&&e.deleteBuffer(this.program_13_position_buffer),this.program_13!=null&&e.deleteProgram(this.program_13),this.program_14_intermediate_texture!=null&&e.deleteTexture(this.program_14_intermediate_texture),this.program_14_position_buffer!=null&&e.deleteBuffer(this.program_14_position_buffer),this.program_14!=null&&e.deleteProgram(this.program_14),this.program_15_intermediate_texture!=null&&e.deleteTexture(this.program_15_intermediate_texture),this.program_15_position_buffer!=null&&e.deleteBuffer(this.program_15_position_buffer),this.program_15!=null&&e.deleteProgram(this.program_15),this.program_16_intermediate_texture!=null&&e.deleteTexture(this.program_16_intermediate_texture),this.program_16_position_buffer!=null&&e.deleteBuffer(this.program_16_position_buffer),this.program_16!=null&&e.deleteProgram(this.program_16)}magnification(){let e=new Map([["MAIN",{width:1,height:1}],["NATIVE",{width:1,height:1}],["OUTPUT",{width:1,height:1}]]);{if(!e.get("MAIN"))return[1,1];let f=e.get("MAIN");if(!f)return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];e.set("conv2d_tf",{width:f.width,height:f.height})}{if(!e.get("MAIN"))return[1,1];let f=e.get("MAIN");if(!f)return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];e.set("conv2d_tf1",{width:f.width,height:f.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_tf");if(!o)return[1,1];if(!e.get("conv2d_tf1"))return[1,1];e.set("conv2d_1_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_tf");if(!o)return[1,1];if(!e.get("conv2d_tf1"))return[1,1];e.set("conv2d_1_tf1",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_1_tf");if(!o)return[1,1];if(!e.get("conv2d_1_tf1"))return[1,1];e.set("conv2d_2_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_1_tf");if(!o)return[1,1];if(!e.get("conv2d_1_tf1"))return[1,1];e.set("conv2d_2_tf1",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_2_tf");if(!o)return[1,1];if(!e.get("conv2d_2_tf1"))return[1,1];e.set("conv2d_3_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_2_tf");if(!o)return[1,1];if(!e.get("conv2d_2_tf1"))return[1,1];e.set("conv2d_3_tf1",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_3_tf");if(!o)return[1,1];if(!e.get("conv2d_3_tf1"))return[1,1];e.set("conv2d_4_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_3_tf");if(!o)return[1,1];if(!e.get("conv2d_3_tf1"))return[1,1];e.set("conv2d_4_tf1",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_4_tf");if(!o)return[1,1];if(!e.get("conv2d_4_tf1"))return[1,1];e.set("conv2d_5_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_4_tf");if(!o)return[1,1];if(!e.get("conv2d_4_tf1"))return[1,1];e.set("conv2d_5_tf1",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_5_tf");if(!o)return[1,1];if(!e.get("conv2d_5_tf1"))return[1,1];e.set("conv2d_6_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_5_tf");if(!o)return[1,1];if(!e.get("conv2d_5_tf1"))return[1,1];e.set("conv2d_6_tf1",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_6_tf");if(!o)return[1,1];if(!e.get("conv2d_6_tf1"))return[1,1];e.set("conv2d_7_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_6_tf");if(!o)return[1,1];if(!e.get("conv2d_6_tf1"))return[1,1];e.set("conv2d_7_tf1",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_1_tf");if(!o)return[1,1];if(!e.get("conv2d_1_tf1"))return[1,1];if(!e.get("conv2d_2_tf"))return[1,1];if(!e.get("conv2d_2_tf1"))return[1,1];if(!e.get("conv2d_3_tf"))return[1,1];if(!e.get("conv2d_3_tf1"))return[1,1];if(!e.get("conv2d_4_tf"))return[1,1];if(!e.get("conv2d_4_tf1"))return[1,1];if(!e.get("conv2d_5_tf"))return[1,1];if(!e.get("conv2d_5_tf1"))return[1,1];if(!e.get("conv2d_6_tf"))return[1,1];if(!e.get("conv2d_6_tf1"))return[1,1];if(!e.get("conv2d_7_tf"))return[1,1];if(!e.get("conv2d_7_tf1"))return[1,1];e.set("MAIN",{width:o.width,height:o.height})}let u=e.get("MAIN")?.width??1,t=e.get("MAIN")?.height??1;return[u,t]}hook_MAIN(e,u){let t=this.gl,a=this.texcoordBuffer;if(a){{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;{let _=this.program_0_intermediate_texture;(this.program_0_intermediate_texture_cached_width!==r.width||this.program_0_intermediate_texture_cached_height!==r.height)&&T(t,_,r.width,r.height),t.viewport(0,0,r.width,r.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,_,0),t.useProgram(this.program_0),this.program_0_position_buffer==null?this.program_0_position_buffer=s(t,0,0,r.width,r.height):(this.program_0_intermediate_texture_cached_width!==r.width||this.program_0_intermediate_texture_cached_height!==r.height)&&(t.deleteBuffer(this.program_0_position_buffer),this.program_0_position_buffer=s(t,0,0,r.width,r.height));let i=this.program_0_position_buffer;c(t,this.program_0_a_position_location,i),c(t,this.program_0_a_texture_coord_location,a),t.uniform2f(this.program_0_u_resolution_location,r.width,r.height),t.uniform2f(this.program_0_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_0_MAIN_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_0_intermediate_texture_cached_width=r.width,this.program_0_intermediate_texture_cached_height=r.height,e.set("conv2d_tf",{texture:_,width:r.width,height:r.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;{let _=this.program_1_intermediate_texture;(this.program_1_intermediate_texture_cached_width!==r.width||this.program_1_intermediate_texture_cached_height!==r.height)&&T(t,_,r.width,r.height),t.viewport(0,0,r.width,r.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,_,0),t.useProgram(this.program_1),this.program_1_position_buffer==null?this.program_1_position_buffer=s(t,0,0,r.width,r.height):(this.program_1_intermediate_texture_cached_width!==r.width||this.program_1_intermediate_texture_cached_height!==r.height)&&(t.deleteBuffer(this.program_1_position_buffer),this.program_1_position_buffer=s(t,0,0,r.width,r.height));let i=this.program_1_position_buffer;c(t,this.program_1_a_position_location,i),c(t,this.program_1_a_texture_coord_location,a),t.uniform2f(this.program_1_u_resolution_location,r.width,r.height),t.uniform2f(this.program_1_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_1_MAIN_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_1_intermediate_texture_cached_width=r.width,this.program_1_intermediate_texture_cached_height=r.height,e.set("conv2d_tf1",{texture:_,width:r.width,height:r.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("conv2d_tf");if(!_)return;let i=e.get("conv2d_tf1");if(!i)return;{let n=this.program_2_intermediate_texture;(this.program_2_intermediate_texture_cached_width!==_.width||this.program_2_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_2),this.program_2_position_buffer==null?this.program_2_position_buffer=s(t,0,0,_.width,_.height):(this.program_2_intermediate_texture_cached_width!==_.width||this.program_2_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_2_position_buffer),this.program_2_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_2_position_buffer;c(t,this.program_2_a_position_location,g),c(t,this.program_2_a_texture_coord_location,a),t.uniform2f(this.program_2_u_resolution_location,_.width,_.height),t.uniform2f(this.program_2_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_2_conv2d_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_2_conv2d_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_2_intermediate_texture_cached_width=_.width,this.program_2_intermediate_texture_cached_height=_.height,e.set("conv2d_1_tf",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("conv2d_tf");if(!_)return;let i=e.get("conv2d_tf1");if(!i)return;{let n=this.program_3_intermediate_texture;(this.program_3_intermediate_texture_cached_width!==_.width||this.program_3_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_3),this.program_3_position_buffer==null?this.program_3_position_buffer=s(t,0,0,_.width,_.height):(this.program_3_intermediate_texture_cached_width!==_.width||this.program_3_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_3_position_buffer),this.program_3_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_3_position_buffer;c(t,this.program_3_a_position_location,g),c(t,this.program_3_a_texture_coord_location,a),t.uniform2f(this.program_3_u_resolution_location,_.width,_.height),t.uniform2f(this.program_3_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_3_conv2d_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_3_conv2d_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_3_intermediate_texture_cached_width=_.width,this.program_3_intermediate_texture_cached_height=_.height,e.set("conv2d_1_tf1",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("conv2d_1_tf");if(!_)return;let i=e.get("conv2d_1_tf1");if(!i)return;{let n=this.program_4_intermediate_texture;(this.program_4_intermediate_texture_cached_width!==_.width||this.program_4_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_4),this.program_4_position_buffer==null?this.program_4_position_buffer=s(t,0,0,_.width,_.height):(this.program_4_intermediate_texture_cached_width!==_.width||this.program_4_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_4_position_buffer),this.program_4_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_4_position_buffer;c(t,this.program_4_a_position_location,g),c(t,this.program_4_a_texture_coord_location,a),t.uniform2f(this.program_4_u_resolution_location,_.width,_.height),t.uniform2f(this.program_4_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_4_conv2d_1_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_4_conv2d_1_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_4_intermediate_texture_cached_width=_.width,this.program_4_intermediate_texture_cached_height=_.height,e.set("conv2d_2_tf",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("conv2d_1_tf");if(!_)return;let i=e.get("conv2d_1_tf1");if(!i)return;{let n=this.program_5_intermediate_texture;(this.program_5_intermediate_texture_cached_width!==_.width||this.program_5_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_5),this.program_5_position_buffer==null?this.program_5_position_buffer=s(t,0,0,_.width,_.height):(this.program_5_intermediate_texture_cached_width!==_.width||this.program_5_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_5_position_buffer),this.program_5_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_5_position_buffer;c(t,this.program_5_a_position_location,g),c(t,this.program_5_a_texture_coord_location,a),t.uniform2f(this.program_5_u_resolution_location,_.width,_.height),t.uniform2f(this.program_5_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_5_conv2d_1_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_5_conv2d_1_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_5_intermediate_texture_cached_width=_.width,this.program_5_intermediate_texture_cached_height=_.height,e.set("conv2d_2_tf1",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("conv2d_2_tf");if(!_)return;let i=e.get("conv2d_2_tf1");if(!i)return;{let n=this.program_6_intermediate_texture;(this.program_6_intermediate_texture_cached_width!==_.width||this.program_6_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_6),this.program_6_position_buffer==null?this.program_6_position_buffer=s(t,0,0,_.width,_.height):(this.program_6_intermediate_texture_cached_width!==_.width||this.program_6_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_6_position_buffer),this.program_6_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_6_position_buffer;c(t,this.program_6_a_position_location,g),c(t,this.program_6_a_texture_coord_location,a),t.uniform2f(this.program_6_u_resolution_location,_.width,_.height),t.uniform2f(this.program_6_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_6_conv2d_2_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_6_conv2d_2_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_6_intermediate_texture_cached_width=_.width,this.program_6_intermediate_texture_cached_height=_.height,e.set("conv2d_3_tf",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("conv2d_2_tf");if(!_)return;let i=e.get("conv2d_2_tf1");if(!i)return;{let n=this.program_7_intermediate_texture;(this.program_7_intermediate_texture_cached_width!==_.width||this.program_7_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_7),this.program_7_position_buffer==null?this.program_7_position_buffer=s(t,0,0,_.width,_.height):(this.program_7_intermediate_texture_cached_width!==_.width||this.program_7_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_7_position_buffer),this.program_7_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_7_position_buffer;c(t,this.program_7_a_position_location,g),c(t,this.program_7_a_texture_coord_location,a),t.uniform2f(this.program_7_u_resolution_location,_.width,_.height),t.uniform2f(this.program_7_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_7_conv2d_2_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_7_conv2d_2_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_7_intermediate_texture_cached_width=_.width,this.program_7_intermediate_texture_cached_height=_.height,e.set("conv2d_3_tf1",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("conv2d_3_tf");if(!_)return;let i=e.get("conv2d_3_tf1");if(!i)return;{let n=this.program_8_intermediate_texture;(this.program_8_intermediate_texture_cached_width!==_.width||this.program_8_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_8),this.program_8_position_buffer==null?this.program_8_position_buffer=s(t,0,0,_.width,_.height):(this.program_8_intermediate_texture_cached_width!==_.width||this.program_8_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_8_position_buffer),this.program_8_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_8_position_buffer;c(t,this.program_8_a_position_location,g),c(t,this.program_8_a_texture_coord_location,a),t.uniform2f(this.program_8_u_resolution_location,_.width,_.height),t.uniform2f(this.program_8_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_8_conv2d_3_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_8_conv2d_3_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_8_intermediate_texture_cached_width=_.width,this.program_8_intermediate_texture_cached_height=_.height,e.set("conv2d_4_tf",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("conv2d_3_tf");if(!_)return;let i=e.get("conv2d_3_tf1");if(!i)return;{let n=this.program_9_intermediate_texture;(this.program_9_intermediate_texture_cached_width!==_.width||this.program_9_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_9),this.program_9_position_buffer==null?this.program_9_position_buffer=s(t,0,0,_.width,_.height):(this.program_9_intermediate_texture_cached_width!==_.width||this.program_9_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_9_position_buffer),this.program_9_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_9_position_buffer;c(t,this.program_9_a_position_location,g),c(t,this.program_9_a_texture_coord_location,a),t.uniform2f(this.program_9_u_resolution_location,_.width,_.height),t.uniform2f(this.program_9_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_9_conv2d_3_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_9_conv2d_3_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_9_intermediate_texture_cached_width=_.width,this.program_9_intermediate_texture_cached_height=_.height,e.set("conv2d_4_tf1",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("conv2d_4_tf");if(!_)return;let i=e.get("conv2d_4_tf1");if(!i)return;{let n=this.program_10_intermediate_texture;(this.program_10_intermediate_texture_cached_width!==_.width||this.program_10_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_10),this.program_10_position_buffer==null?this.program_10_position_buffer=s(t,0,0,_.width,_.height):(this.program_10_intermediate_texture_cached_width!==_.width||this.program_10_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_10_position_buffer),this.program_10_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_10_position_buffer;c(t,this.program_10_a_position_location,g),c(t,this.program_10_a_texture_coord_location,a),t.uniform2f(this.program_10_u_resolution_location,_.width,_.height),t.uniform2f(this.program_10_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_10_conv2d_4_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_10_conv2d_4_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_10_intermediate_texture_cached_width=_.width,this.program_10_intermediate_texture_cached_height=_.height,e.set("conv2d_5_tf",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("conv2d_4_tf");if(!_)return;let i=e.get("conv2d_4_tf1");if(!i)return;{let n=this.program_11_intermediate_texture;(this.program_11_intermediate_texture_cached_width!==_.width||this.program_11_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_11),this.program_11_position_buffer==null?this.program_11_position_buffer=s(t,0,0,_.width,_.height):(this.program_11_intermediate_texture_cached_width!==_.width||this.program_11_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_11_position_buffer),this.program_11_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_11_position_buffer;c(t,this.program_11_a_position_location,g),c(t,this.program_11_a_texture_coord_location,a),t.uniform2f(this.program_11_u_resolution_location,_.width,_.height),t.uniform2f(this.program_11_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_11_conv2d_4_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_11_conv2d_4_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_11_intermediate_texture_cached_width=_.width,this.program_11_intermediate_texture_cached_height=_.height,e.set("conv2d_5_tf1",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("conv2d_5_tf");if(!_)return;let i=e.get("conv2d_5_tf1");if(!i)return;{let n=this.program_12_intermediate_texture;(this.program_12_intermediate_texture_cached_width!==_.width||this.program_12_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_12),this.program_12_position_buffer==null?this.program_12_position_buffer=s(t,0,0,_.width,_.height):(this.program_12_intermediate_texture_cached_width!==_.width||this.program_12_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_12_position_buffer),this.program_12_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_12_position_buffer;c(t,this.program_12_a_position_location,g),c(t,this.program_12_a_texture_coord_location,a),t.uniform2f(this.program_12_u_resolution_location,_.width,_.height),t.uniform2f(this.program_12_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_12_conv2d_5_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_12_conv2d_5_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_12_intermediate_texture_cached_width=_.width,this.program_12_intermediate_texture_cached_height=_.height,e.set("conv2d_6_tf",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("conv2d_5_tf");if(!_)return;let i=e.get("conv2d_5_tf1");if(!i)return;{let n=this.program_13_intermediate_texture;(this.program_13_intermediate_texture_cached_width!==_.width||this.program_13_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_13),this.program_13_position_buffer==null?this.program_13_position_buffer=s(t,0,0,_.width,_.height):(this.program_13_intermediate_texture_cached_width!==_.width||this.program_13_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_13_position_buffer),this.program_13_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_13_position_buffer;c(t,this.program_13_a_position_location,g),c(t,this.program_13_a_texture_coord_location,a),t.uniform2f(this.program_13_u_resolution_location,_.width,_.height),t.uniform2f(this.program_13_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_13_conv2d_5_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_13_conv2d_5_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_13_intermediate_texture_cached_width=_.width,this.program_13_intermediate_texture_cached_height=_.height,e.set("conv2d_6_tf1",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("conv2d_6_tf");if(!_)return;let i=e.get("conv2d_6_tf1");if(!i)return;{let n=this.program_14_intermediate_texture;(this.program_14_intermediate_texture_cached_width!==_.width||this.program_14_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_14),this.program_14_position_buffer==null?this.program_14_position_buffer=s(t,0,0,_.width,_.height):(this.program_14_intermediate_texture_cached_width!==_.width||this.program_14_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_14_position_buffer),this.program_14_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_14_position_buffer;c(t,this.program_14_a_position_location,g),c(t,this.program_14_a_texture_coord_location,a),t.uniform2f(this.program_14_u_resolution_location,_.width,_.height),t.uniform2f(this.program_14_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_14_conv2d_6_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_14_conv2d_6_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_14_intermediate_texture_cached_width=_.width,this.program_14_intermediate_texture_cached_height=_.height,e.set("conv2d_7_tf",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("conv2d_6_tf");if(!_)return;let i=e.get("conv2d_6_tf1");if(!i)return;{let n=this.program_15_intermediate_texture;(this.program_15_intermediate_texture_cached_width!==_.width||this.program_15_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_15),this.program_15_position_buffer==null?this.program_15_position_buffer=s(t,0,0,_.width,_.height):(this.program_15_intermediate_texture_cached_width!==_.width||this.program_15_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_15_position_buffer),this.program_15_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_15_position_buffer;c(t,this.program_15_a_position_location,g),c(t,this.program_15_a_texture_coord_location,a),t.uniform2f(this.program_15_u_resolution_location,_.width,_.height),t.uniform2f(this.program_15_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_15_conv2d_6_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_15_conv2d_6_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_15_intermediate_texture_cached_width=_.width,this.program_15_intermediate_texture_cached_height=_.height,e.set("conv2d_7_tf1",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE")||!e.get("OUTPUT"))return;let _=e.get("conv2d_1_tf");if(!_)return;let i=e.get("conv2d_1_tf1");if(!i)return;let n=e.get("conv2d_2_tf");if(!n)return;let g=e.get("conv2d_2_tf1");if(!g)return;let U=e.get("conv2d_3_tf");if(!U)return;let E=e.get("conv2d_3_tf1");if(!E)return;let b=e.get("conv2d_4_tf");if(!b)return;let L=e.get("conv2d_4_tf1");if(!L)return;let R=e.get("conv2d_5_tf");if(!R)return;let O=e.get("conv2d_5_tf1");if(!O)return;let I=e.get("conv2d_6_tf");if(!I)return;let A=e.get("conv2d_6_tf1");if(!A)return;let h=e.get("conv2d_7_tf");if(!h)return;let z=e.get("conv2d_7_tf1");if(!z)return;{let D=this.program_16_intermediate_texture;(this.program_16_intermediate_texture_cached_width!==_.width||this.program_16_intermediate_texture_cached_height!==_.height)&&T(t,D,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,D,0),t.useProgram(this.program_16),this.program_16_position_buffer==null?this.program_16_position_buffer=s(t,0,0,_.width,_.height):(this.program_16_intermediate_texture_cached_width!==_.width||this.program_16_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_16_position_buffer),this.program_16_position_buffer=s(t,0,0,_.width,_.height));let P=this.program_16_position_buffer;c(t,this.program_16_a_position_location,P),c(t,this.program_16_a_texture_coord_location,a),t.uniform2f(this.program_16_u_resolution_location,_.width,_.height),t.uniform2f(this.program_16_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_16_MAIN_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_16_conv2d_1_tf_TextureLocation,1),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_16_conv2d_1_tf1_TextureLocation,2),t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,n.texture),t.uniform1i(this.program_16_conv2d_2_tf_TextureLocation,3),t.activeTexture(t.TEXTURE4),t.bindTexture(t.TEXTURE_2D,g.texture),t.uniform1i(this.program_16_conv2d_2_tf1_TextureLocation,4),t.activeTexture(t.TEXTURE5),t.bindTexture(t.TEXTURE_2D,U.texture),t.uniform1i(this.program_16_conv2d_3_tf_TextureLocation,5),t.activeTexture(t.TEXTURE6),t.bindTexture(t.TEXTURE_2D,E.texture),t.uniform1i(this.program_16_conv2d_3_tf1_TextureLocation,6),t.activeTexture(t.TEXTURE7),t.bindTexture(t.TEXTURE_2D,b.texture),t.uniform1i(this.program_16_conv2d_4_tf_TextureLocation,7),t.activeTexture(t.TEXTURE8),t.bindTexture(t.TEXTURE_2D,L.texture),t.uniform1i(this.program_16_conv2d_4_tf1_TextureLocation,8),t.activeTexture(t.TEXTURE9),t.bindTexture(t.TEXTURE_2D,R.texture),t.uniform1i(this.program_16_conv2d_5_tf_TextureLocation,9),t.activeTexture(t.TEXTURE10),t.bindTexture(t.TEXTURE_2D,O.texture),t.uniform1i(this.program_16_conv2d_5_tf1_TextureLocation,10),t.activeTexture(t.TEXTURE11),t.bindTexture(t.TEXTURE_2D,I.texture),t.uniform1i(this.program_16_conv2d_6_tf_TextureLocation,11),t.activeTexture(t.TEXTURE12),t.bindTexture(t.TEXTURE_2D,A.texture),t.uniform1i(this.program_16_conv2d_6_tf1_TextureLocation,12),t.activeTexture(t.TEXTURE13),t.bindTexture(t.TEXTURE_2D,h.texture),t.uniform1i(this.program_16_conv2d_7_tf_TextureLocation,13),t.activeTexture(t.TEXTURE14),t.bindTexture(t.TEXTURE_2D,z.texture),t.uniform1i(this.program_16_conv2d_7_tf1_TextureLocation,14),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE4),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE5),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE6),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE7),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE8),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE9),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE10),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE11),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE12),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE13),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE14),t.bindTexture(t.TEXTURE_2D,null),this.program_16_intermediate_texture_cached_width=_.width,this.program_16_intermediate_texture_cached_height=_.height,e.set("MAIN",{texture:D,width:_.width,height:_.height})}}}}hook_PREKERNEL(e,u){let t=this.gl;this.texcoordBuffer}};var X=`
precision highp float;
...
`,H=class extends M{gl;texcoordBuffer;program_0;program_1;program_2;program_3;program_4;program_5;program_6;program_7;program_8;program_0_intermediate_texture;program_1_intermediate_texture;program_2_intermediate_texture;program_3_intermediate_texture;program_4_intermediate_texture;program_5_intermediate_texture;program_6_intermediate_texture;program_7_intermediate_texture;program_8_intermediate_texture;program_0_intermediate_texture_cached_width;program_1_intermediate_texture_cached_width;program_2_intermediate_texture_cached_width;program_3_intermediate_texture_cached_width;program_4_intermediate_texture_cached_width;program_5_intermediate_texture_cached_width;program_6_intermediate_texture_cached_width;program_7_intermediate_texture_cached_width;program_8_intermediate_texture_cached_width;program_0_intermediate_texture_cached_height;program_1_intermediate_texture_cached_height;program_2_intermediate_texture_cached_height;program_3_intermediate_texture_cached_height;program_4_intermediate_texture_cached_height;program_5_intermediate_texture_cached_height;program_6_intermediate_texture_cached_height;program_7_intermediate_texture_cached_height;program_8_intermediate_texture_cached_height;program_0_a_position_location;program_1_a_position_location;program_2_a_position_location;program_3_a_position_location;program_4_a_position_location;program_5_a_position_location;program_6_a_position_location;program_7_a_position_location;program_8_a_position_location;program_0_a_texture_coord_location;program_1_a_texture_coord_location;program_2_a_texture_coord_location;program_3_a_texture_coord_location;program_4_a_texture_coord_location;program_5_a_texture_coord_location;program_6_a_texture_coord_location;program_7_a_texture_coord_location;program_8_a_texture_coord_location;program_0_u_resolution_location;program_1_u_resolution_location;program_2_u_resolution_location;program_3_u_resolution_location;program_4_u_resolution_location;program_5_u_resolution_location;program_6_u_resolution_location;program_7_u_resolution_location;program_8_u_resolution_location;program_0_u_texture_size_location;program_1_u_texture_size_location;program_2_u_texture_size_location;program_3_u_texture_size_location;program_4_u_texture_size_location;program_5_u_texture_size_location;program_6_u_texture_size_location;program_7_u_texture_size_location;program_8_u_texture_size_location;program_0_MAIN_TextureLocation;program_1_conv2d_tf_TextureLocation;program_2_conv2d_1_tf_TextureLocation;program_3_conv2d_2_tf_TextureLocation;program_4_conv2d_3_tf_TextureLocation;program_5_conv2d_4_tf_TextureLocation;program_6_conv2d_5_tf_TextureLocation;program_7_conv2d_tf_TextureLocation;program_7_conv2d_1_tf_TextureLocation;program_7_conv2d_2_tf_TextureLocation;program_7_conv2d_3_tf_TextureLocation;program_7_conv2d_4_tf_TextureLocation;program_7_conv2d_5_tf_TextureLocation;program_7_conv2d_6_tf_TextureLocation;program_8_MAIN_TextureLocation;program_8_conv2d_last_tf_TextureLocation;program_0_position_buffer;program_1_position_buffer;program_2_position_buffer;program_3_position_buffer;program_4_position_buffer;program_5_position_buffer;program_6_position_buffer;program_7_position_buffer;program_8_position_buffer;constructor(e){super(),this.gl=e,this.texcoordBuffer=s(e,0,0,1,1),this.program_0=x(e,v(e,X),l(e,L0)),this.program_1=x(e,v(e,X),l(e,R0)),this.program_2=x(e,v(e,X),l(e,N0)),this.program_3=x(e,v(e,X),l(e,w0)),this.program_4=x(e,v(e,X),l(e,O0)),this.program_5=x(e,v(e,X),l(e,I0)),this.program_6=x(e,v(e,X),l(e,D0)),this.program_7=x(e,v(e,X),l(e,M0)),this.program_8=x(e,v(e,X),l(e,z0)),this.program_0_intermediate_texture=p(e,e.NEAREST),this.program_1_intermediate_texture=p(e,e.NEAREST),this.program_2_intermediate_texture=p(e,e.NEAREST),this.program_3_intermediate_texture=p(e,e.NEAREST),this.program_4_intermediate_texture=p(e,e.NEAREST),this.program_5_intermediate_texture=p(e,e.NEAREST),this.program_6_intermediate_texture=p(e,e.NEAREST),this.program_7_intermediate_texture=p(e,e.NEAREST),this.program_8_intermediate_texture=p(e,e.NEAREST),this.program_0_intermediate_texture_cached_width=null,this.program_1_intermediate_texture_cached_width=null,this.program_2_intermediate_texture_cached_width=null,this.program_3_intermediate_texture_cached_width=null,this.program_4_intermediate_texture_cached_width=null,this.program_5_intermediate_texture_cached_width=null,this.program_6_intermediate_texture_cached_width=null,this.program_7_intermediate_texture_cached_width=null,this.program_8_intermediate_texture_cached_width=null,this.program_0_intermediate_texture_cached_height=null,this.program_1_intermediate_texture_cached_height=null,this.program_2_intermediate_texture_cached_height=null,this.program_3_intermediate_texture_cached_height=null,this.program_4_intermediate_texture_cached_height=null,this.program_5_intermediate_texture_cached_height=null,this.program_6_intermediate_texture_cached_height=null,this.program_7_intermediate_texture_cached_height=null,this.program_8_intermediate_texture_cached_height=null,this.program_0_a_position_location=e.getAttribLocation(this.program_0,"a_position"),e.enableVertexAttribArray(this.program_0_a_position_location),this.program_1_a_position_location=e.getAttribLocation(this.program_1,"a_position"),e.enableVertexAttribArray(this.program_1_a_position_location),this.program_2_a_position_location=e.getAttribLocation(this.program_2,"a_position"),e.enableVertexAttribArray(this.program_2_a_position_location),this.program_3_a_position_location=e.getAttribLocation(this.program_3,"a_position"),e.enableVertexAttribArray(this.program_3_a_position_location),this.program_4_a_position_location=e.getAttribLocation(this.program_4,"a_position"),e.enableVertexAttribArray(this.program_4_a_position_location),this.program_5_a_position_location=e.getAttribLocation(this.program_5,"a_position"),e.enableVertexAttribArray(this.program_5_a_position_location),this.program_6_a_position_location=e.getAttribLocation(this.program_6,"a_position"),e.enableVertexAttribArray(this.program_6_a_position_location),this.program_7_a_position_location=e.getAttribLocation(this.program_7,"a_position"),e.enableVertexAttribArray(this.program_7_a_position_location),this.program_8_a_position_location=e.getAttribLocation(this.program_8,"a_position"),e.enableVertexAttribArray(this.program_8_a_position_location),this.program_0_a_texture_coord_location=e.getAttribLocation(this.program_0,"a_texture_coord"),e.enableVertexAttribArray(this.program_0_a_texture_coord_location),this.program_1_a_texture_coord_location=e.getAttribLocation(this.program_1,"a_texture_coord"),e.enableVertexAttribArray(this.program_1_a_texture_coord_location),this.program_2_a_texture_coord_location=e.getAttribLocation(this.program_2,"a_texture_coord"),e.enableVertexAttribArray(this.program_2_a_texture_coord_location),this.program_3_a_texture_coord_location=e.getAttribLocation(this.program_3,"a_texture_coord"),e.enableVertexAttribArray(this.program_3_a_texture_coord_location),this.program_4_a_texture_coord_location=e.getAttribLocation(this.program_4,"a_texture_coord"),e.enableVertexAttribArray(this.program_4_a_texture_coord_location),this.program_5_a_texture_coord_location=e.getAttribLocation(this.program_5,"a_texture_coord"),e.enableVertexAttribArray(this.program_5_a_texture_coord_location),this.program_6_a_texture_coord_location=e.getAttribLocation(this.program_6,"a_texture_coord"),e.enableVertexAttribArray(this.program_6_a_texture_coord_location),this.program_7_a_texture_coord_location=e.getAttribLocation(this.program_7,"a_texture_coord"),e.enableVertexAttribArray(this.program_7_a_texture_coord_location),this.program_8_a_texture_coord_location=e.getAttribLocation(this.program_8,"a_texture_coord"),e.enableVertexAttribArray(this.program_8_a_texture_coord_location),this.program_0_u_resolution_location=e.getUniformLocation(this.program_0,"u_resolution"),this.program_1_u_resolution_location=e.getUniformLocation(this.program_1,"u_resolution"),this.program_2_u_resolution_location=e.getUniformLocation(this.program_2,"u_resolution"),this.program_3_u_resolution_location=e.getUniformLocation(this.program_3,"u_resolution"),this.program_4_u_resolution_location=e.getUniformLocation(this.program_4,"u_resolution"),this.program_5_u_resolution_location=e.getUniformLocation(this.program_5,"u_resolution"),this.program_6_u_resolution_location=e.getUniformLocation(this.program_6,"u_resolution"),this.program_7_u_resolution_location=e.getUniformLocation(this.program_7,"u_resolution"),this.program_8_u_resolution_location=e.getUniformLocation(this.program_8,"u_resolution"),this.program_0_u_texture_size_location=e.getUniformLocation(this.program_0,"u_texture_size"),this.program_1_u_texture_size_location=e.getUniformLocation(this.program_1,"u_texture_size"),this.program_2_u_texture_size_location=e.getUniformLocation(this.program_2,"u_texture_size"),this.program_3_u_texture_size_location=e.getUniformLocation(this.program_3,"u_texture_size"),this.program_4_u_texture_size_location=e.getUniformLocation(this.program_4,"u_texture_size"),this.program_5_u_texture_size_location=e.getUniformLocation(this.program_5,"u_texture_size"),this.program_6_u_texture_size_location=e.getUniformLocation(this.program_6,"u_texture_size"),this.program_7_u_texture_size_location=e.getUniformLocation(this.program_7,"u_texture_size"),this.program_8_u_texture_size_location=e.getUniformLocation(this.program_8,"u_texture_size"),this.program_0_MAIN_TextureLocation=e.getUniformLocation(this.program_0,"MAIN"),this.program_1_conv2d_tf_TextureLocation=e.getUniformLocation(this.program_1,"conv2d_tf"),this.program_2_conv2d_1_tf_TextureLocation=e.getUniformLocation(this.program_2,"conv2d_1_tf"),this.program_3_conv2d_2_tf_TextureLocation=e.getUniformLocation(this.program_3,"conv2d_2_tf"),this.program_4_conv2d_3_tf_TextureLocation=e.getUniformLocation(this.program_4,"conv2d_3_tf"),this.program_5_conv2d_4_tf_TextureLocation=e.getUniformLocation(this.program_5,"conv2d_4_tf"),this.program_6_conv2d_5_tf_TextureLocation=e.getUniformLocation(this.program_6,"conv2d_5_tf"),this.program_7_conv2d_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_tf"),this.program_7_conv2d_1_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_1_tf"),this.program_7_conv2d_2_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_2_tf"),this.program_7_conv2d_3_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_3_tf"),this.program_7_conv2d_4_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_4_tf"),this.program_7_conv2d_5_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_5_tf"),this.program_7_conv2d_6_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_6_tf"),this.program_8_MAIN_TextureLocation=e.getUniformLocation(this.program_8,"MAIN"),this.program_8_conv2d_last_tf_TextureLocation=e.getUniformLocation(this.program_8,"conv2d_last_tf"),this.program_0_position_buffer=null,this.program_1_position_buffer=null,this.program_2_position_buffer=null,this.program_3_position_buffer=null,this.program_4_position_buffer=null,this.program_5_position_buffer=null,this.program_6_position_buffer=null,this.program_7_position_buffer=null,this.program_8_position_buffer=null}destroy(){let e=this.gl;this.texcoordBuffer!=null&&e.deleteBuffer(this.texcoordBuffer),this.program_0_intermediate_texture!=null&&e.deleteTexture(this.program_0_intermediate_texture),this.program_0_position_buffer!=null&&e.deleteBuffer(this.program_0_position_buffer),this.program_0!=null&&e.deleteProgram(this.program_0),this.program_1_intermediate_texture!=null&&e.deleteTexture(this.program_1_intermediate_texture),this.program_1_position_buffer!=null&&e.deleteBuffer(this.program_1_position_buffer),this.program_1!=null&&e.deleteProgram(this.program_1),this.program_2_intermediate_texture!=null&&e.deleteTexture(this.program_2_intermediate_texture),this.program_2_position_buffer!=null&&e.deleteBuffer(this.program_2_position_buffer),this.program_2!=null&&e.deleteProgram(this.program_2),this.program_3_intermediate_texture!=null&&e.deleteTexture(this.program_3_intermediate_texture),this.program_3_position_buffer!=null&&e.deleteBuffer(this.program_3_position_buffer),this.program_3!=null&&e.deleteProgram(this.program_3),this.program_4_intermediate_texture!=null&&e.deleteTexture(this.program_4_intermediate_texture),this.program_4_position_buffer!=null&&e.deleteBuffer(this.program_4_position_buffer),this.program_4!=null&&e.deleteProgram(this.program_4),this.program_5_intermediate_texture!=null&&e.deleteTexture(this.program_5_intermediate_texture),this.program_5_position_buffer!=null&&e.deleteBuffer(this.program_5_position_buffer),this.program_5!=null&&e.deleteProgram(this.program_5),this.program_6_intermediate_texture!=null&&e.deleteTexture(this.program_6_intermediate_texture),this.program_6_position_buffer!=null&&e.deleteBuffer(this.program_6_position_buffer),this.program_6!=null&&e.deleteProgram(this.program_6),this.program_7_intermediate_texture!=null&&e.deleteTexture(this.program_7_intermediate_texture),this.program_7_position_buffer!=null&&e.deleteBuffer(this.program_7_position_buffer),this.program_7!=null&&e.deleteProgram(this.program_7),this.program_8_intermediate_texture!=null&&e.deleteTexture(this.program_8_intermediate_texture),this.program_8_position_buffer!=null&&e.deleteBuffer(this.program_8_position_buffer),this.program_8!=null&&e.deleteProgram(this.program_8)}magnification(){let e=new Map([["MAIN",{width:1,height:1}],["NATIVE",{width:1,height:1}],["OUTPUT",{width:1,height:1}]]);{if(!e.get("MAIN"))return[1,1];let f=e.get("MAIN");if(!f)return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];e.set("conv2d_tf",{width:f.width,height:f.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_tf");if(!o)return[1,1];e.set("conv2d_1_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_1_tf");if(!o)return[1,1];e.set("conv2d_2_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_2_tf");if(!o)return[1,1];e.set("conv2d_3_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_3_tf");if(!o)return[1,1];e.set("conv2d_4_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_4_tf");if(!o)return[1,1];e.set("conv2d_5_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_5_tf");if(!o)return[1,1];e.set("conv2d_6_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];if(!e.get("conv2d_1_tf"))return[1,1];if(!e.get("conv2d_2_tf"))return[1,1];if(!e.get("conv2d_3_tf"))return[1,1];if(!e.get("conv2d_4_tf"))return[1,1];if(!e.get("conv2d_5_tf"))return[1,1];if(!e.get("conv2d_6_tf"))return[1,1];let E=e.get("conv2d_tf");if(!E)return[1,1];e.set("conv2d_last_tf",{width:E.width,height:E.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_last_tf");if(!o)return[1,1];e.set("MAIN",{width:o.width*2,height:o.height*2})}let u=e.get("MAIN")?.width??1,t=e.get("MAIN")?.height??1;return[u,t]}hook_MAIN(e,u){let t=this.gl,a=this.texcoordBuffer;if(a){{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let _=this.program_0_intermediate_texture;(this.program_0_intermediate_texture_cached_width!==r.width||this.program_0_intermediate_texture_cached_height!==r.height)&&T(t,_,r.width,r.height),t.viewport(0,0,r.width,r.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,_,0),t.useProgram(this.program_0),this.program_0_position_buffer==null?this.program_0_position_buffer=s(t,0,0,r.width,r.height):(this.program_0_intermediate_texture_cached_width!==r.width||this.program_0_intermediate_texture_cached_height!==r.height)&&(t.deleteBuffer(this.program_0_position_buffer),this.program_0_position_buffer=s(t,0,0,r.width,r.height));let i=this.program_0_position_buffer;c(t,this.program_0_a_position_location,i),c(t,this.program_0_a_texture_coord_location,a),t.uniform2f(this.program_0_u_resolution_location,r.width,r.height),t.uniform2f(this.program_0_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_0_MAIN_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_0_intermediate_texture_cached_width=r.width,this.program_0_intermediate_texture_cached_height=r.height,e.set("conv2d_tf",{texture:_,width:r.width,height:r.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_tf");if(!_)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let i=this.program_1_intermediate_texture;(this.program_1_intermediate_texture_cached_width!==_.width||this.program_1_intermediate_texture_cached_height!==_.height)&&T(t,i,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,i,0),t.useProgram(this.program_1),this.program_1_position_buffer==null?this.program_1_position_buffer=s(t,0,0,_.width,_.height):(this.program_1_intermediate_texture_cached_width!==_.width||this.program_1_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_1_position_buffer),this.program_1_position_buffer=s(t,0,0,_.width,_.height));let n=this.program_1_position_buffer;c(t,this.program_1_a_position_location,n),c(t,this.program_1_a_texture_coord_location,a),t.uniform2f(this.program_1_u_resolution_location,_.width,_.height),t.uniform2f(this.program_1_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_1_conv2d_tf_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_1_intermediate_texture_cached_width=_.width,this.program_1_intermediate_texture_cached_height=_.height,e.set("conv2d_1_tf",{texture:i,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_1_tf");if(!_)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let i=this.program_2_intermediate_texture;(this.program_2_intermediate_texture_cached_width!==_.width||this.program_2_intermediate_texture_cached_height!==_.height)&&T(t,i,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,i,0),t.useProgram(this.program_2),this.program_2_position_buffer==null?this.program_2_position_buffer=s(t,0,0,_.width,_.height):(this.program_2_intermediate_texture_cached_width!==_.width||this.program_2_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_2_position_buffer),this.program_2_position_buffer=s(t,0,0,_.width,_.height));let n=this.program_2_position_buffer;c(t,this.program_2_a_position_location,n),c(t,this.program_2_a_texture_coord_location,a),t.uniform2f(this.program_2_u_resolution_location,_.width,_.height),t.uniform2f(this.program_2_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_2_conv2d_1_tf_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_2_intermediate_texture_cached_width=_.width,this.program_2_intermediate_texture_cached_height=_.height,e.set("conv2d_2_tf",{texture:i,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_2_tf");if(!_)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let i=this.program_3_intermediate_texture;(this.program_3_intermediate_texture_cached_width!==_.width||this.program_3_intermediate_texture_cached_height!==_.height)&&T(t,i,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,i,0),t.useProgram(this.program_3),this.program_3_position_buffer==null?this.program_3_position_buffer=s(t,0,0,_.width,_.height):(this.program_3_intermediate_texture_cached_width!==_.width||this.program_3_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_3_position_buffer),this.program_3_position_buffer=s(t,0,0,_.width,_.height));let n=this.program_3_position_buffer;c(t,this.program_3_a_position_location,n),c(t,this.program_3_a_texture_coord_location,a),t.uniform2f(this.program_3_u_resolution_location,_.width,_.height),t.uniform2f(this.program_3_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_3_conv2d_2_tf_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_3_intermediate_texture_cached_width=_.width,this.program_3_intermediate_texture_cached_height=_.height,e.set("conv2d_3_tf",{texture:i,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_3_tf");if(!_)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let i=this.program_4_intermediate_texture;(this.program_4_intermediate_texture_cached_width!==_.width||this.program_4_intermediate_texture_cached_height!==_.height)&&T(t,i,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,i,0),t.useProgram(this.program_4),this.program_4_position_buffer==null?this.program_4_position_buffer=s(t,0,0,_.width,_.height):(this.program_4_intermediate_texture_cached_width!==_.width||this.program_4_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_4_position_buffer),this.program_4_position_buffer=s(t,0,0,_.width,_.height));let n=this.program_4_position_buffer;c(t,this.program_4_a_position_location,n),c(t,this.program_4_a_texture_coord_location,a),t.uniform2f(this.program_4_u_resolution_location,_.width,_.height),t.uniform2f(this.program_4_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_4_conv2d_3_tf_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_4_intermediate_texture_cached_width=_.width,this.program_4_intermediate_texture_cached_height=_.height,e.set("conv2d_4_tf",{texture:i,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_4_tf");if(!_)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let i=this.program_5_intermediate_texture;(this.program_5_intermediate_texture_cached_width!==_.width||this.program_5_intermediate_texture_cached_height!==_.height)&&T(t,i,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,i,0),t.useProgram(this.program_5),this.program_5_position_buffer==null?this.program_5_position_buffer=s(t,0,0,_.width,_.height):(this.program_5_intermediate_texture_cached_width!==_.width||this.program_5_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_5_position_buffer),this.program_5_position_buffer=s(t,0,0,_.width,_.height));let n=this.program_5_position_buffer;c(t,this.program_5_a_position_location,n),c(t,this.program_5_a_texture_coord_location,a),t.uniform2f(this.program_5_u_resolution_location,_.width,_.height),t.uniform2f(this.program_5_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_5_conv2d_4_tf_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_5_intermediate_texture_cached_width=_.width,this.program_5_intermediate_texture_cached_height=_.height,e.set("conv2d_5_tf",{texture:i,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_5_tf");if(!_)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let i=this.program_6_intermediate_texture;(this.program_6_intermediate_texture_cached_width!==_.width||this.program_6_intermediate_texture_cached_height!==_.height)&&T(t,i,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,i,0),t.useProgram(this.program_6),this.program_6_position_buffer==null?this.program_6_position_buffer=s(t,0,0,_.width,_.height):(this.program_6_intermediate_texture_cached_width!==_.width||this.program_6_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_6_position_buffer),this.program_6_position_buffer=s(t,0,0,_.width,_.height));let n=this.program_6_position_buffer;c(t,this.program_6_a_position_location,n),c(t,this.program_6_a_texture_coord_location,a),t.uniform2f(this.program_6_u_resolution_location,_.width,_.height),t.uniform2f(this.program_6_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_6_conv2d_5_tf_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_6_intermediate_texture_cached_width=_.width,this.program_6_intermediate_texture_cached_height=_.height,e.set("conv2d_6_tf",{texture:i,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_1_tf");if(!_)return;let i=e.get("conv2d_2_tf");if(!i)return;let n=e.get("conv2d_3_tf");if(!n)return;let g=e.get("conv2d_4_tf");if(!g)return;let U=e.get("conv2d_5_tf");if(!U)return;let E=e.get("conv2d_6_tf");if(!E)return;let b=e.get("conv2d_tf");if(!b)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let L=this.program_7_intermediate_texture;(this.program_7_intermediate_texture_cached_width!==b.width||this.program_7_intermediate_texture_cached_height!==b.height)&&T(t,L,b.width,b.height),t.viewport(0,0,b.width,b.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,L,0),t.useProgram(this.program_7),this.program_7_position_buffer==null?this.program_7_position_buffer=s(t,0,0,b.width,b.height):(this.program_7_intermediate_texture_cached_width!==b.width||this.program_7_intermediate_texture_cached_height!==b.height)&&(t.deleteBuffer(this.program_7_position_buffer),this.program_7_position_buffer=s(t,0,0,b.width,b.height));let R=this.program_7_position_buffer;c(t,this.program_7_a_position_location,R),c(t,this.program_7_a_texture_coord_location,a),t.uniform2f(this.program_7_u_resolution_location,b.width,b.height),t.uniform2f(this.program_7_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,b.texture),t.uniform1i(this.program_7_conv2d_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_7_conv2d_1_tf_TextureLocation,1),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_7_conv2d_2_tf_TextureLocation,2),t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,n.texture),t.uniform1i(this.program_7_conv2d_3_tf_TextureLocation,3),t.activeTexture(t.TEXTURE4),t.bindTexture(t.TEXTURE_2D,g.texture),t.uniform1i(this.program_7_conv2d_4_tf_TextureLocation,4),t.activeTexture(t.TEXTURE5),t.bindTexture(t.TEXTURE_2D,U.texture),t.uniform1i(this.program_7_conv2d_5_tf_TextureLocation,5),t.activeTexture(t.TEXTURE6),t.bindTexture(t.TEXTURE_2D,E.texture),t.uniform1i(this.program_7_conv2d_6_tf_TextureLocation,6),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE4),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE5),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE6),t.bindTexture(t.TEXTURE_2D,null),this.program_7_intermediate_texture_cached_width=b.width,this.program_7_intermediate_texture_cached_height=b.height,e.set("conv2d_last_tf",{texture:L,width:b.width,height:b.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_last_tf");if(!_)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let i=this.program_8_intermediate_texture;(this.program_8_intermediate_texture_cached_width!==_.width*2||this.program_8_intermediate_texture_cached_height!==_.height*2)&&T(t,i,_.width*2,_.height*2),t.viewport(0,0,_.width*2,_.height*2),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,i,0),t.useProgram(this.program_8),this.program_8_position_buffer==null?this.program_8_position_buffer=s(t,0,0,_.width*2,_.height*2):(this.program_8_intermediate_texture_cached_width!==_.width*2||this.program_8_intermediate_texture_cached_height!==_.height*2)&&(t.deleteBuffer(this.program_8_position_buffer),this.program_8_position_buffer=s(t,0,0,_.width*2,_.height*2));let n=this.program_8_position_buffer;c(t,this.program_8_a_position_location,n),c(t,this.program_8_a_texture_coord_location,a),t.uniform2f(this.program_8_u_resolution_location,_.width*2,_.height*2),t.uniform2f(this.program_8_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_8_MAIN_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_8_conv2d_last_tf_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_8_intermediate_texture_cached_width=_.width*2,this.program_8_intermediate_texture_cached_height=_.height*2,e.set("MAIN",{texture:i,width:_.width*2,height:_.height*2})}}}}hook_PREKERNEL(e,u){let t=this.gl;this.texcoordBuffer}};var N=`
precision highp float;
...
`,S=class extends M{gl;texcoordBuffer;program_0;program_1;program_2;program_3;program_4;program_5;program_6;program_7;program_8;program_9;program_10;program_11;program_12;program_13;program_14;program_15;program_16;program_17;program_0_intermediate_texture;program_1_intermediate_texture;program_2_intermediate_texture;program_3_intermediate_texture;program_4_intermediate_texture;program_5_intermediate_texture;program_6_intermediate_texture;program_7_intermediate_texture;program_8_intermediate_texture;program_9_intermediate_texture;program_10_intermediate_texture;program_11_intermediate_texture;program_12_intermediate_texture;program_13_intermediate_texture;program_14_intermediate_texture;program_15_intermediate_texture;program_16_intermediate_texture;program_17_intermediate_texture;program_0_intermediate_texture_cached_width;program_1_intermediate_texture_cached_width;program_2_intermediate_texture_cached_width;program_3_intermediate_texture_cached_width;program_4_intermediate_texture_cached_width;program_5_intermediate_texture_cached_width;program_6_intermediate_texture_cached_width;program_7_intermediate_texture_cached_width;program_8_intermediate_texture_cached_width;program_9_intermediate_texture_cached_width;program_10_intermediate_texture_cached_width;program_11_intermediate_texture_cached_width;program_12_intermediate_texture_cached_width;program_13_intermediate_texture_cached_width;program_14_intermediate_texture_cached_width;program_15_intermediate_texture_cached_width;program_16_intermediate_texture_cached_width;program_17_intermediate_texture_cached_width;program_0_intermediate_texture_cached_height;program_1_intermediate_texture_cached_height;program_2_intermediate_texture_cached_height;program_3_intermediate_texture_cached_height;program_4_intermediate_texture_cached_height;program_5_intermediate_texture_cached_height;program_6_intermediate_texture_cached_height;program_7_intermediate_texture_cached_height;program_8_intermediate_texture_cached_height;program_9_intermediate_texture_cached_height;program_10_intermediate_texture_cached_height;program_11_intermediate_texture_cached_height;program_12_intermediate_texture_cached_height;program_13_intermediate_texture_cached_height;program_14_intermediate_texture_cached_height;program_15_intermediate_texture_cached_height;program_16_intermediate_texture_cached_height;program_17_intermediate_texture_cached_height;program_0_a_position_location;program_1_a_position_location;program_2_a_position_location;program_3_a_position_location;program_4_a_position_location;program_5_a_position_location;program_6_a_position_location;program_7_a_position_location;program_8_a_position_location;program_9_a_position_location;program_10_a_position_location;program_11_a_position_location;program_12_a_position_location;program_13_a_position_location;program_14_a_position_location;program_15_a_position_location;program_16_a_position_location;program_17_a_position_location;program_0_a_texture_coord_location;program_1_a_texture_coord_location;program_2_a_texture_coord_location;program_3_a_texture_coord_location;program_4_a_texture_coord_location;program_5_a_texture_coord_location;program_6_a_texture_coord_location;program_7_a_texture_coord_location;program_8_a_texture_coord_location;program_9_a_texture_coord_location;program_10_a_texture_coord_location;program_11_a_texture_coord_location;program_12_a_texture_coord_location;program_13_a_texture_coord_location;program_14_a_texture_coord_location;program_15_a_texture_coord_location;program_16_a_texture_coord_location;program_17_a_texture_coord_location;program_0_u_resolution_location;program_1_u_resolution_location;program_2_u_resolution_location;program_3_u_resolution_location;program_4_u_resolution_location;program_5_u_resolution_location;program_6_u_resolution_location;program_7_u_resolution_location;program_8_u_resolution_location;program_9_u_resolution_location;program_10_u_resolution_location;program_11_u_resolution_location;program_12_u_resolution_location;program_13_u_resolution_location;program_14_u_resolution_location;program_15_u_resolution_location;program_16_u_resolution_location;program_17_u_resolution_location;program_0_u_texture_size_location;program_1_u_texture_size_location;program_2_u_texture_size_location;program_3_u_texture_size_location;program_4_u_texture_size_location;program_5_u_texture_size_location;program_6_u_texture_size_location;program_7_u_texture_size_location;program_8_u_texture_size_location;program_9_u_texture_size_location;program_10_u_texture_size_location;program_11_u_texture_size_location;program_12_u_texture_size_location;program_13_u_texture_size_location;program_14_u_texture_size_location;program_15_u_texture_size_location;program_16_u_texture_size_location;program_17_u_texture_size_location;program_0_MAIN_TextureLocation;program_1_MAIN_TextureLocation;program_2_conv2d_tf_TextureLocation;program_2_conv2d_tf1_TextureLocation;program_3_conv2d_tf_TextureLocation;program_3_conv2d_tf1_TextureLocation;program_4_conv2d_1_tf_TextureLocation;program_4_conv2d_1_tf1_TextureLocation;program_5_conv2d_1_tf_TextureLocation;program_5_conv2d_1_tf1_TextureLocation;program_6_conv2d_2_tf_TextureLocation;program_6_conv2d_2_tf1_TextureLocation;program_7_conv2d_2_tf_TextureLocation;program_7_conv2d_2_tf1_TextureLocation;program_8_conv2d_3_tf_TextureLocation;program_8_conv2d_3_tf1_TextureLocation;program_9_conv2d_3_tf_TextureLocation;program_9_conv2d_3_tf1_TextureLocation;program_10_conv2d_4_tf_TextureLocation;program_10_conv2d_4_tf1_TextureLocation;program_11_conv2d_4_tf_TextureLocation;program_11_conv2d_4_tf1_TextureLocation;program_12_conv2d_5_tf_TextureLocation;program_12_conv2d_5_tf1_TextureLocation;program_13_conv2d_5_tf_TextureLocation;program_13_conv2d_5_tf1_TextureLocation;program_14_conv2d_tf_TextureLocation;program_14_conv2d_tf1_TextureLocation;program_14_conv2d_1_tf_TextureLocation;program_14_conv2d_1_tf1_TextureLocation;program_14_conv2d_2_tf_TextureLocation;program_14_conv2d_2_tf1_TextureLocation;program_14_conv2d_3_tf_TextureLocation;program_14_conv2d_3_tf1_TextureLocation;program_14_conv2d_4_tf_TextureLocation;program_14_conv2d_4_tf1_TextureLocation;program_14_conv2d_5_tf_TextureLocation;program_14_conv2d_5_tf1_TextureLocation;program_14_conv2d_6_tf_TextureLocation;program_14_conv2d_6_tf1_TextureLocation;program_15_conv2d_tf_TextureLocation;program_15_conv2d_tf1_TextureLocation;program_15_conv2d_1_tf_TextureLocation;program_15_conv2d_1_tf1_TextureLocation;program_15_conv2d_2_tf_TextureLocation;program_15_conv2d_2_tf1_TextureLocation;program_15_conv2d_3_tf_TextureLocation;program_15_conv2d_3_tf1_TextureLocation;program_15_conv2d_4_tf_TextureLocation;program_15_conv2d_4_tf1_TextureLocation;program_15_conv2d_5_tf_TextureLocation;program_15_conv2d_5_tf1_TextureLocation;program_15_conv2d_6_tf_TextureLocation;program_15_conv2d_6_tf1_TextureLocation;program_16_conv2d_tf_TextureLocation;program_16_conv2d_tf1_TextureLocation;program_16_conv2d_1_tf_TextureLocation;program_16_conv2d_1_tf1_TextureLocation;program_16_conv2d_2_tf_TextureLocation;program_16_conv2d_2_tf1_TextureLocation;program_16_conv2d_3_tf_TextureLocation;program_16_conv2d_3_tf1_TextureLocation;program_16_conv2d_4_tf_TextureLocation;program_16_conv2d_4_tf1_TextureLocation;program_16_conv2d_5_tf_TextureLocation;program_16_conv2d_5_tf1_TextureLocation;program_16_conv2d_6_tf_TextureLocation;program_16_conv2d_6_tf1_TextureLocation;program_17_MAIN_TextureLocation;program_17_conv2d_last_tf_TextureLocation;program_17_conv2d_last_tf1_TextureLocation;program_17_conv2d_last_tf2_TextureLocation;program_0_position_buffer;program_1_position_buffer;program_2_position_buffer;program_3_position_buffer;program_4_position_buffer;program_5_position_buffer;program_6_position_buffer;program_7_position_buffer;program_8_position_buffer;program_9_position_buffer;program_10_position_buffer;program_11_position_buffer;program_12_position_buffer;program_13_position_buffer;program_14_position_buffer;program_15_position_buffer;program_16_position_buffer;program_17_position_buffer;constructor(e){super(),this.gl=e,this.texcoordBuffer=s(e,0,0,1,1),this.program_0=x(e,v(e,N),l(e,X0)),this.program_1=x(e,v(e,N),l(e,G0)),this.program_2=x(e,v(e,N),l(e,P0)),this.program_3=x(e,v(e,N),l(e,y0)),this.program_4=x(e,v(e,N),l(e,F0)),this.program_5=x(e,v(e,N),l(e,W0)),this.program_6=x(e,v(e,N),l(e,V0)),this.program_7=x(e,v(e,N),l(e,B0)),this.program_8=x(e,v(e,N),l(e,H0)),this.program_9=x(e,v(e,N),l(e,S0)),this.program_10=x(e,v(e,N),l(e,K0)),this.program_11=x(e,v(e,N),l(e,C0)),this.program_12=x(e,v(e,N),l(e,k0)),this.program_13=x(e,v(e,N),l(e,Y0)),this.program_14=x(e,v(e,N),l(e,Z0)),this.program_15=x(e,v(e,N),l(e,q0)),this.program_16=x(e,v(e,N),l(e,j0)),this.program_17=x(e,v(e,N),l(e,J0)),this.program_0_intermediate_texture=p(e,e.NEAREST),this.program_1_intermediate_texture=p(e,e.NEAREST),this.program_2_intermediate_texture=p(e,e.NEAREST),this.program_3_intermediate_texture=p(e,e.NEAREST),this.program_4_intermediate_texture=p(e,e.NEAREST),this.program_5_intermediate_texture=p(e,e.NEAREST),this.program_6_intermediate_texture=p(e,e.NEAREST),this.program_7_intermediate_texture=p(e,e.NEAREST),this.program_8_intermediate_texture=p(e,e.NEAREST),this.program_9_intermediate_texture=p(e,e.NEAREST),this.program_10_intermediate_texture=p(e,e.NEAREST),this.program_11_intermediate_texture=p(e,e.NEAREST),this.program_12_intermediate_texture=p(e,e.NEAREST),this.program_13_intermediate_texture=p(e,e.NEAREST),this.program_14_intermediate_texture=p(e,e.NEAREST),this.program_15_intermediate_texture=p(e,e.NEAREST),this.program_16_intermediate_texture=p(e,e.NEAREST),this.program_17_intermediate_texture=p(e,e.NEAREST),this.program_0_intermediate_texture_cached_width=null,this.program_1_intermediate_texture_cached_width=null,this.program_2_intermediate_texture_cached_width=null,this.program_3_intermediate_texture_cached_width=null,this.program_4_intermediate_texture_cached_width=null,this.program_5_intermediate_texture_cached_width=null,this.program_6_intermediate_texture_cached_width=null,this.program_7_intermediate_texture_cached_width=null,this.program_8_intermediate_texture_cached_width=null,this.program_9_intermediate_texture_cached_width=null,this.program_10_intermediate_texture_cached_width=null,this.program_11_intermediate_texture_cached_width=null,this.program_12_intermediate_texture_cached_width=null,this.program_13_intermediate_texture_cached_width=null,this.program_14_intermediate_texture_cached_width=null,this.program_15_intermediate_texture_cached_width=null,this.program_16_intermediate_texture_cached_width=null,this.program_17_intermediate_texture_cached_width=null,this.program_0_intermediate_texture_cached_height=null,this.program_1_intermediate_texture_cached_height=null,this.program_2_intermediate_texture_cached_height=null,this.program_3_intermediate_texture_cached_height=null,this.program_4_intermediate_texture_cached_height=null,this.program_5_intermediate_texture_cached_height=null,this.program_6_intermediate_texture_cached_height=null,this.program_7_intermediate_texture_cached_height=null,this.program_8_intermediate_texture_cached_height=null,this.program_9_intermediate_texture_cached_height=null,this.program_10_intermediate_texture_cached_height=null,this.program_11_intermediate_texture_cached_height=null,this.program_12_intermediate_texture_cached_height=null,this.program_13_intermediate_texture_cached_height=null,this.program_14_intermediate_texture_cached_height=null,this.program_15_intermediate_texture_cached_height=null,this.program_16_intermediate_texture_cached_height=null,this.program_17_intermediate_texture_cached_height=null,this.program_0_a_position_location=e.getAttribLocation(this.program_0,"a_position"),e.enableVertexAttribArray(this.program_0_a_position_location),this.program_1_a_position_location=e.getAttribLocation(this.program_1,"a_position"),e.enableVertexAttribArray(this.program_1_a_position_location),this.program_2_a_position_location=e.getAttribLocation(this.program_2,"a_position"),e.enableVertexAttribArray(this.program_2_a_position_location),this.program_3_a_position_location=e.getAttribLocation(this.program_3,"a_position"),e.enableVertexAttribArray(this.program_3_a_position_location),this.program_4_a_position_location=e.getAttribLocation(this.program_4,"a_position"),e.enableVertexAttribArray(this.program_4_a_position_location),this.program_5_a_position_location=e.getAttribLocation(this.program_5,"a_position"),e.enableVertexAttribArray(this.program_5_a_position_location),this.program_6_a_position_location=e.getAttribLocation(this.program_6,"a_position"),e.enableVertexAttribArray(this.program_6_a_position_location),this.program_7_a_position_location=e.getAttribLocation(this.program_7,"a_position"),e.enableVertexAttribArray(this.program_7_a_position_location),this.program_8_a_position_location=e.getAttribLocation(this.program_8,"a_position"),e.enableVertexAttribArray(this.program_8_a_position_location),this.program_9_a_position_location=e.getAttribLocation(this.program_9,"a_position"),e.enableVertexAttribArray(this.program_9_a_position_location),this.program_10_a_position_location=e.getAttribLocation(this.program_10,"a_position"),e.enableVertexAttribArray(this.program_10_a_position_location),this.program_11_a_position_location=e.getAttribLocation(this.program_11,"a_position"),e.enableVertexAttribArray(this.program_11_a_position_location),this.program_12_a_position_location=e.getAttribLocation(this.program_12,"a_position"),e.enableVertexAttribArray(this.program_12_a_position_location),this.program_13_a_position_location=e.getAttribLocation(this.program_13,"a_position"),e.enableVertexAttribArray(this.program_13_a_position_location),this.program_14_a_position_location=e.getAttribLocation(this.program_14,"a_position"),e.enableVertexAttribArray(this.program_14_a_position_location),this.program_15_a_position_location=e.getAttribLocation(this.program_15,"a_position"),e.enableVertexAttribArray(this.program_15_a_position_location),this.program_16_a_position_location=e.getAttribLocation(this.program_16,"a_position"),e.enableVertexAttribArray(this.program_16_a_position_location),this.program_17_a_position_location=e.getAttribLocation(this.program_17,"a_position"),e.enableVertexAttribArray(this.program_17_a_position_location),this.program_0_a_texture_coord_location=e.getAttribLocation(this.program_0,"a_texture_coord"),e.enableVertexAttribArray(this.program_0_a_texture_coord_location),this.program_1_a_texture_coord_location=e.getAttribLocation(this.program_1,"a_texture_coord"),e.enableVertexAttribArray(this.program_1_a_texture_coord_location),this.program_2_a_texture_coord_location=e.getAttribLocation(this.program_2,"a_texture_coord"),e.enableVertexAttribArray(this.program_2_a_texture_coord_location),this.program_3_a_texture_coord_location=e.getAttribLocation(this.program_3,"a_texture_coord"),e.enableVertexAttribArray(this.program_3_a_texture_coord_location),this.program_4_a_texture_coord_location=e.getAttribLocation(this.program_4,"a_texture_coord"),e.enableVertexAttribArray(this.program_4_a_texture_coord_location),this.program_5_a_texture_coord_location=e.getAttribLocation(this.program_5,"a_texture_coord"),e.enableVertexAttribArray(this.program_5_a_texture_coord_location),this.program_6_a_texture_coord_location=e.getAttribLocation(this.program_6,"a_texture_coord"),e.enableVertexAttribArray(this.program_6_a_texture_coord_location),this.program_7_a_texture_coord_location=e.getAttribLocation(this.program_7,"a_texture_coord"),e.enableVertexAttribArray(this.program_7_a_texture_coord_location),this.program_8_a_texture_coord_location=e.getAttribLocation(this.program_8,"a_texture_coord"),e.enableVertexAttribArray(this.program_8_a_texture_coord_location),this.program_9_a_texture_coord_location=e.getAttribLocation(this.program_9,"a_texture_coord"),e.enableVertexAttribArray(this.program_9_a_texture_coord_location),this.program_10_a_texture_coord_location=e.getAttribLocation(this.program_10,"a_texture_coord"),e.enableVertexAttribArray(this.program_10_a_texture_coord_location),this.program_11_a_texture_coord_location=e.getAttribLocation(this.program_11,"a_texture_coord"),e.enableVertexAttribArray(this.program_11_a_texture_coord_location),this.program_12_a_texture_coord_location=e.getAttribLocation(this.program_12,"a_texture_coord"),e.enableVertexAttribArray(this.program_12_a_texture_coord_location),this.program_13_a_texture_coord_location=e.getAttribLocation(this.program_13,"a_texture_coord"),e.enableVertexAttribArray(this.program_13_a_texture_coord_location),this.program_14_a_texture_coord_location=e.getAttribLocation(this.program_14,"a_texture_coord"),e.enableVertexAttribArray(this.program_14_a_texture_coord_location),this.program_15_a_texture_coord_location=e.getAttribLocation(this.program_15,"a_texture_coord"),e.enableVertexAttribArray(this.program_15_a_texture_coord_location),this.program_16_a_texture_coord_location=e.getAttribLocation(this.program_16,"a_texture_coord"),e.enableVertexAttribArray(this.program_16_a_texture_coord_location),this.program_17_a_texture_coord_location=e.getAttribLocation(this.program_17,"a_texture_coord"),e.enableVertexAttribArray(this.program_17_a_texture_coord_location),this.program_0_u_resolution_location=e.getUniformLocation(this.program_0,"u_resolution"),this.program_1_u_resolution_location=e.getUniformLocation(this.program_1,"u_resolution"),this.program_2_u_resolution_location=e.getUniformLocation(this.program_2,"u_resolution"),this.program_3_u_resolution_location=e.getUniformLocation(this.program_3,"u_resolution"),this.program_4_u_resolution_location=e.getUniformLocation(this.program_4,"u_resolution"),this.program_5_u_resolution_location=e.getUniformLocation(this.program_5,"u_resolution"),this.program_6_u_resolution_location=e.getUniformLocation(this.program_6,"u_resolution"),this.program_7_u_resolution_location=e.getUniformLocation(this.program_7,"u_resolution"),this.program_8_u_resolution_location=e.getUniformLocation(this.program_8,"u_resolution"),this.program_9_u_resolution_location=e.getUniformLocation(this.program_9,"u_resolution"),this.program_10_u_resolution_location=e.getUniformLocation(this.program_10,"u_resolution"),this.program_11_u_resolution_location=e.getUniformLocation(this.program_11,"u_resolution"),this.program_12_u_resolution_location=e.getUniformLocation(this.program_12,"u_resolution"),this.program_13_u_resolution_location=e.getUniformLocation(this.program_13,"u_resolution"),this.program_14_u_resolution_location=e.getUniformLocation(this.program_14,"u_resolution"),this.program_15_u_resolution_location=e.getUniformLocation(this.program_15,"u_resolution"),this.program_16_u_resolution_location=e.getUniformLocation(this.program_16,"u_resolution"),this.program_17_u_resolution_location=e.getUniformLocation(this.program_17,"u_resolution"),this.program_0_u_texture_size_location=e.getUniformLocation(this.program_0,"u_texture_size"),this.program_1_u_texture_size_location=e.getUniformLocation(this.program_1,"u_texture_size"),this.program_2_u_texture_size_location=e.getUniformLocation(this.program_2,"u_texture_size"),this.program_3_u_texture_size_location=e.getUniformLocation(this.program_3,"u_texture_size"),this.program_4_u_texture_size_location=e.getUniformLocation(this.program_4,"u_texture_size"),this.program_5_u_texture_size_location=e.getUniformLocation(this.program_5,"u_texture_size"),this.program_6_u_texture_size_location=e.getUniformLocation(this.program_6,"u_texture_size"),this.program_7_u_texture_size_location=e.getUniformLocation(this.program_7,"u_texture_size"),this.program_8_u_texture_size_location=e.getUniformLocation(this.program_8,"u_texture_size"),this.program_9_u_texture_size_location=e.getUniformLocation(this.program_9,"u_texture_size"),this.program_10_u_texture_size_location=e.getUniformLocation(this.program_10,"u_texture_size"),this.program_11_u_texture_size_location=e.getUniformLocation(this.program_11,"u_texture_size"),this.program_12_u_texture_size_location=e.getUniformLocation(this.program_12,"u_texture_size"),this.program_13_u_texture_size_location=e.getUniformLocation(this.program_13,"u_texture_size"),this.program_14_u_texture_size_location=e.getUniformLocation(this.program_14,"u_texture_size"),this.program_15_u_texture_size_location=e.getUniformLocation(this.program_15,"u_texture_size"),this.program_16_u_texture_size_location=e.getUniformLocation(this.program_16,"u_texture_size"),this.program_17_u_texture_size_location=e.getUniformLocation(this.program_17,"u_texture_size"),this.program_0_MAIN_TextureLocation=e.getUniformLocation(this.program_0,"MAIN"),this.program_1_MAIN_TextureLocation=e.getUniformLocation(this.program_1,"MAIN"),this.program_2_conv2d_tf_TextureLocation=e.getUniformLocation(this.program_2,"conv2d_tf"),this.program_2_conv2d_tf1_TextureLocation=e.getUniformLocation(this.program_2,"conv2d_tf1"),this.program_3_conv2d_tf_TextureLocation=e.getUniformLocation(this.program_3,"conv2d_tf"),this.program_3_conv2d_tf1_TextureLocation=e.getUniformLocation(this.program_3,"conv2d_tf1"),this.program_4_conv2d_1_tf_TextureLocation=e.getUniformLocation(this.program_4,"conv2d_1_tf"),this.program_4_conv2d_1_tf1_TextureLocation=e.getUniformLocation(this.program_4,"conv2d_1_tf1"),this.program_5_conv2d_1_tf_TextureLocation=e.getUniformLocation(this.program_5,"conv2d_1_tf"),this.program_5_conv2d_1_tf1_TextureLocation=e.getUniformLocation(this.program_5,"conv2d_1_tf1"),this.program_6_conv2d_2_tf_TextureLocation=e.getUniformLocation(this.program_6,"conv2d_2_tf"),this.program_6_conv2d_2_tf1_TextureLocation=e.getUniformLocation(this.program_6,"conv2d_2_tf1"),this.program_7_conv2d_2_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_2_tf"),this.program_7_conv2d_2_tf1_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_2_tf1"),this.program_8_conv2d_3_tf_TextureLocation=e.getUniformLocation(this.program_8,"conv2d_3_tf"),this.program_8_conv2d_3_tf1_TextureLocation=e.getUniformLocation(this.program_8,"conv2d_3_tf1"),this.program_9_conv2d_3_tf_TextureLocation=e.getUniformLocation(this.program_9,"conv2d_3_tf"),this.program_9_conv2d_3_tf1_TextureLocation=e.getUniformLocation(this.program_9,"conv2d_3_tf1"),this.program_10_conv2d_4_tf_TextureLocation=e.getUniformLocation(this.program_10,"conv2d_4_tf"),this.program_10_conv2d_4_tf1_TextureLocation=e.getUniformLocation(this.program_10,"conv2d_4_tf1"),this.program_11_conv2d_4_tf_TextureLocation=e.getUniformLocation(this.program_11,"conv2d_4_tf"),this.program_11_conv2d_4_tf1_TextureLocation=e.getUniformLocation(this.program_11,"conv2d_4_tf1"),this.program_12_conv2d_5_tf_TextureLocation=e.getUniformLocation(this.program_12,"conv2d_5_tf"),this.program_12_conv2d_5_tf1_TextureLocation=e.getUniformLocation(this.program_12,"conv2d_5_tf1"),this.program_13_conv2d_5_tf_TextureLocation=e.getUniformLocation(this.program_13,"conv2d_5_tf"),this.program_13_conv2d_5_tf1_TextureLocation=e.getUniformLocation(this.program_13,"conv2d_5_tf1"),this.program_14_conv2d_tf_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_tf"),this.program_14_conv2d_tf1_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_tf1"),this.program_14_conv2d_1_tf_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_1_tf"),this.program_14_conv2d_1_tf1_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_1_tf1"),this.program_14_conv2d_2_tf_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_2_tf"),this.program_14_conv2d_2_tf1_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_2_tf1"),this.program_14_conv2d_3_tf_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_3_tf"),this.program_14_conv2d_3_tf1_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_3_tf1"),this.program_14_conv2d_4_tf_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_4_tf"),this.program_14_conv2d_4_tf1_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_4_tf1"),this.program_14_conv2d_5_tf_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_5_tf"),this.program_14_conv2d_5_tf1_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_5_tf1"),this.program_14_conv2d_6_tf_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_6_tf"),this.program_14_conv2d_6_tf1_TextureLocation=e.getUniformLocation(this.program_14,"conv2d_6_tf1"),this.program_15_conv2d_tf_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_tf"),this.program_15_conv2d_tf1_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_tf1"),this.program_15_conv2d_1_tf_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_1_tf"),this.program_15_conv2d_1_tf1_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_1_tf1"),this.program_15_conv2d_2_tf_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_2_tf"),this.program_15_conv2d_2_tf1_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_2_tf1"),this.program_15_conv2d_3_tf_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_3_tf"),this.program_15_conv2d_3_tf1_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_3_tf1"),this.program_15_conv2d_4_tf_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_4_tf"),this.program_15_conv2d_4_tf1_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_4_tf1"),this.program_15_conv2d_5_tf_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_5_tf"),this.program_15_conv2d_5_tf1_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_5_tf1"),this.program_15_conv2d_6_tf_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_6_tf"),this.program_15_conv2d_6_tf1_TextureLocation=e.getUniformLocation(this.program_15,"conv2d_6_tf1"),this.program_16_conv2d_tf_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_tf"),this.program_16_conv2d_tf1_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_tf1"),this.program_16_conv2d_1_tf_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_1_tf"),this.program_16_conv2d_1_tf1_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_1_tf1"),this.program_16_conv2d_2_tf_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_2_tf"),this.program_16_conv2d_2_tf1_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_2_tf1"),this.program_16_conv2d_3_tf_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_3_tf"),this.program_16_conv2d_3_tf1_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_3_tf1"),this.program_16_conv2d_4_tf_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_4_tf"),this.program_16_conv2d_4_tf1_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_4_tf1"),this.program_16_conv2d_5_tf_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_5_tf"),this.program_16_conv2d_5_tf1_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_5_tf1"),this.program_16_conv2d_6_tf_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_6_tf"),this.program_16_conv2d_6_tf1_TextureLocation=e.getUniformLocation(this.program_16,"conv2d_6_tf1"),this.program_17_MAIN_TextureLocation=e.getUniformLocation(this.program_17,"MAIN"),this.program_17_conv2d_last_tf_TextureLocation=e.getUniformLocation(this.program_17,"conv2d_last_tf"),this.program_17_conv2d_last_tf1_TextureLocation=e.getUniformLocation(this.program_17,"conv2d_last_tf1"),this.program_17_conv2d_last_tf2_TextureLocation=e.getUniformLocation(this.program_17,"conv2d_last_tf2"),this.program_0_position_buffer=null,this.program_1_position_buffer=null,this.program_2_position_buffer=null,this.program_3_position_buffer=null,this.program_4_position_buffer=null,this.program_5_position_buffer=null,this.program_6_position_buffer=null,this.program_7_position_buffer=null,this.program_8_position_buffer=null,this.program_9_position_buffer=null,this.program_10_position_buffer=null,this.program_11_position_buffer=null,this.program_12_position_buffer=null,this.program_13_position_buffer=null,this.program_14_position_buffer=null,this.program_15_position_buffer=null,this.program_16_position_buffer=null,this.program_17_position_buffer=null}destroy(){let e=this.gl;this.texcoordBuffer!=null&&e.deleteBuffer(this.texcoordBuffer),this.program_0_intermediate_texture!=null&&e.deleteTexture(this.program_0_intermediate_texture),this.program_0_position_buffer!=null&&e.deleteBuffer(this.program_0_position_buffer),this.program_0!=null&&e.deleteProgram(this.program_0),this.program_1_intermediate_texture!=null&&e.deleteTexture(this.program_1_intermediate_texture),this.program_1_position_buffer!=null&&e.deleteBuffer(this.program_1_position_buffer),this.program_1!=null&&e.deleteProgram(this.program_1),this.program_2_intermediate_texture!=null&&e.deleteTexture(this.program_2_intermediate_texture),this.program_2_position_buffer!=null&&e.deleteBuffer(this.program_2_position_buffer),this.program_2!=null&&e.deleteProgram(this.program_2),this.program_3_intermediate_texture!=null&&e.deleteTexture(this.program_3_intermediate_texture),this.program_3_position_buffer!=null&&e.deleteBuffer(this.program_3_position_buffer),this.program_3!=null&&e.deleteProgram(this.program_3),this.program_4_intermediate_texture!=null&&e.deleteTexture(this.program_4_intermediate_texture),this.program_4_position_buffer!=null&&e.deleteBuffer(this.program_4_position_buffer),this.program_4!=null&&e.deleteProgram(this.program_4),this.program_5_intermediate_texture!=null&&e.deleteTexture(this.program_5_intermediate_texture),this.program_5_position_buffer!=null&&e.deleteBuffer(this.program_5_position_buffer),this.program_5!=null&&e.deleteProgram(this.program_5),this.program_6_intermediate_texture!=null&&e.deleteTexture(this.program_6_intermediate_texture),this.program_6_position_buffer!=null&&e.deleteBuffer(this.program_6_position_buffer),this.program_6!=null&&e.deleteProgram(this.program_6),this.program_7_intermediate_texture!=null&&e.deleteTexture(this.program_7_intermediate_texture),this.program_7_position_buffer!=null&&e.deleteBuffer(this.program_7_position_buffer),this.program_7!=null&&e.deleteProgram(this.program_7),this.program_8_intermediate_texture!=null&&e.deleteTexture(this.program_8_intermediate_texture),this.program_8_position_buffer!=null&&e.deleteBuffer(this.program_8_position_buffer),this.program_8!=null&&e.deleteProgram(this.program_8),this.program_9_intermediate_texture!=null&&e.deleteTexture(this.program_9_intermediate_texture),this.program_9_position_buffer!=null&&e.deleteBuffer(this.program_9_position_buffer),this.program_9!=null&&e.deleteProgram(this.program_9),this.program_10_intermediate_texture!=null&&e.deleteTexture(this.program_10_intermediate_texture),this.program_10_position_buffer!=null&&e.deleteBuffer(this.program_10_position_buffer),this.program_10!=null&&e.deleteProgram(this.program_10),this.program_11_intermediate_texture!=null&&e.deleteTexture(this.program_11_intermediate_texture),this.program_11_position_buffer!=null&&e.deleteBuffer(this.program_11_position_buffer),this.program_11!=null&&e.deleteProgram(this.program_11),this.program_12_intermediate_texture!=null&&e.deleteTexture(this.program_12_intermediate_texture),this.program_12_position_buffer!=null&&e.deleteBuffer(this.program_12_position_buffer),this.program_12!=null&&e.deleteProgram(this.program_12),this.program_13_intermediate_texture!=null&&e.deleteTexture(this.program_13_intermediate_texture),this.program_13_position_buffer!=null&&e.deleteBuffer(this.program_13_position_buffer),this.program_13!=null&&e.deleteProgram(this.program_13),this.program_14_intermediate_texture!=null&&e.deleteTexture(this.program_14_intermediate_texture),this.program_14_position_buffer!=null&&e.deleteBuffer(this.program_14_position_buffer),this.program_14!=null&&e.deleteProgram(this.program_14),this.program_15_intermediate_texture!=null&&e.deleteTexture(this.program_15_intermediate_texture),this.program_15_position_buffer!=null&&e.deleteBuffer(this.program_15_position_buffer),this.program_15!=null&&e.deleteProgram(this.program_15),this.program_16_intermediate_texture!=null&&e.deleteTexture(this.program_16_intermediate_texture),this.program_16_position_buffer!=null&&e.deleteBuffer(this.program_16_position_buffer),this.program_16!=null&&e.deleteProgram(this.program_16),this.program_17_intermediate_texture!=null&&e.deleteTexture(this.program_17_intermediate_texture),this.program_17_position_buffer!=null&&e.deleteBuffer(this.program_17_position_buffer),this.program_17!=null&&e.deleteProgram(this.program_17)}magnification(){let e=new Map([["MAIN",{width:1,height:1}],["NATIVE",{width:1,height:1}],["OUTPUT",{width:1,height:1}]]);{if(!e.get("MAIN"))return[1,1];let f=e.get("MAIN");if(!f)return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];e.set("conv2d_tf",{width:f.width,height:f.height})}{if(!e.get("MAIN"))return[1,1];let f=e.get("MAIN");if(!f)return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];e.set("conv2d_tf1",{width:f.width,height:f.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_tf");if(!o)return[1,1];if(!e.get("conv2d_tf1"))return[1,1];e.set("conv2d_1_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_tf");if(!o)return[1,1];if(!e.get("conv2d_tf1"))return[1,1];e.set("conv2d_1_tf1",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_1_tf");if(!o)return[1,1];if(!e.get("conv2d_1_tf1"))return[1,1];e.set("conv2d_2_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_1_tf");if(!o)return[1,1];if(!e.get("conv2d_1_tf1"))return[1,1];e.set("conv2d_2_tf1",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_2_tf");if(!o)return[1,1];if(!e.get("conv2d_2_tf1"))return[1,1];e.set("conv2d_3_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_2_tf");if(!o)return[1,1];if(!e.get("conv2d_2_tf1"))return[1,1];e.set("conv2d_3_tf1",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_3_tf");if(!o)return[1,1];if(!e.get("conv2d_3_tf1"))return[1,1];e.set("conv2d_4_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_3_tf");if(!o)return[1,1];if(!e.get("conv2d_3_tf1"))return[1,1];e.set("conv2d_4_tf1",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_4_tf");if(!o)return[1,1];if(!e.get("conv2d_4_tf1"))return[1,1];e.set("conv2d_5_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_4_tf");if(!o)return[1,1];if(!e.get("conv2d_4_tf1"))return[1,1];e.set("conv2d_5_tf1",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_5_tf");if(!o)return[1,1];if(!e.get("conv2d_5_tf1"))return[1,1];e.set("conv2d_6_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_5_tf");if(!o)return[1,1];if(!e.get("conv2d_5_tf1"))return[1,1];e.set("conv2d_6_tf1",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];if(!e.get("conv2d_1_tf"))return[1,1];if(!e.get("conv2d_1_tf1"))return[1,1];if(!e.get("conv2d_2_tf"))return[1,1];if(!e.get("conv2d_2_tf1"))return[1,1];if(!e.get("conv2d_3_tf"))return[1,1];if(!e.get("conv2d_3_tf1"))return[1,1];if(!e.get("conv2d_4_tf"))return[1,1];if(!e.get("conv2d_4_tf1"))return[1,1];if(!e.get("conv2d_5_tf"))return[1,1];if(!e.get("conv2d_5_tf1"))return[1,1];if(!e.get("conv2d_6_tf"))return[1,1];if(!e.get("conv2d_6_tf1"))return[1,1];let A=e.get("conv2d_tf");if(!A)return[1,1];if(!e.get("conv2d_tf1"))return[1,1];e.set("conv2d_last_tf",{width:A.width,height:A.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];if(!e.get("conv2d_1_tf"))return[1,1];if(!e.get("conv2d_1_tf1"))return[1,1];if(!e.get("conv2d_2_tf"))return[1,1];if(!e.get("conv2d_2_tf1"))return[1,1];if(!e.get("conv2d_3_tf"))return[1,1];if(!e.get("conv2d_3_tf1"))return[1,1];if(!e.get("conv2d_4_tf"))return[1,1];if(!e.get("conv2d_4_tf1"))return[1,1];if(!e.get("conv2d_5_tf"))return[1,1];if(!e.get("conv2d_5_tf1"))return[1,1];if(!e.get("conv2d_6_tf"))return[1,1];if(!e.get("conv2d_6_tf1"))return[1,1];let A=e.get("conv2d_tf");if(!A)return[1,1];if(!e.get("conv2d_tf1"))return[1,1];e.set("conv2d_last_tf1",{width:A.width,height:A.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];if(!e.get("conv2d_1_tf"))return[1,1];if(!e.get("conv2d_1_tf1"))return[1,1];if(!e.get("conv2d_2_tf"))return[1,1];if(!e.get("conv2d_2_tf1"))return[1,1];if(!e.get("conv2d_3_tf"))return[1,1];if(!e.get("conv2d_3_tf1"))return[1,1];if(!e.get("conv2d_4_tf"))return[1,1];if(!e.get("conv2d_4_tf1"))return[1,1];if(!e.get("conv2d_5_tf"))return[1,1];if(!e.get("conv2d_5_tf1"))return[1,1];if(!e.get("conv2d_6_tf"))return[1,1];if(!e.get("conv2d_6_tf1"))return[1,1];let A=e.get("conv2d_tf");if(!A)return[1,1];if(!e.get("conv2d_tf1"))return[1,1];e.set("conv2d_last_tf2",{width:A.width,height:A.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_last_tf");if(!o)return[1,1];if(!e.get("conv2d_last_tf1"))return[1,1];if(!e.get("conv2d_last_tf2"))return[1,1];e.set("MAIN",{width:o.width*2,height:o.height*2})}let u=e.get("MAIN")?.width??1,t=e.get("MAIN")?.height??1;return[u,t]}hook_MAIN(e,u){let t=this.gl,a=this.texcoordBuffer;if(a){{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let _=this.program_0_intermediate_texture;(this.program_0_intermediate_texture_cached_width!==r.width||this.program_0_intermediate_texture_cached_height!==r.height)&&T(t,_,r.width,r.height),t.viewport(0,0,r.width,r.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,_,0),t.useProgram(this.program_0),this.program_0_position_buffer==null?this.program_0_position_buffer=s(t,0,0,r.width,r.height):(this.program_0_intermediate_texture_cached_width!==r.width||this.program_0_intermediate_texture_cached_height!==r.height)&&(t.deleteBuffer(this.program_0_position_buffer),this.program_0_position_buffer=s(t,0,0,r.width,r.height));let i=this.program_0_position_buffer;c(t,this.program_0_a_position_location,i),c(t,this.program_0_a_texture_coord_location,a),t.uniform2f(this.program_0_u_resolution_location,r.width,r.height),t.uniform2f(this.program_0_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_0_MAIN_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_0_intermediate_texture_cached_width=r.width,this.program_0_intermediate_texture_cached_height=r.height,e.set("conv2d_tf",{texture:_,width:r.width,height:r.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let _=this.program_1_intermediate_texture;(this.program_1_intermediate_texture_cached_width!==r.width||this.program_1_intermediate_texture_cached_height!==r.height)&&T(t,_,r.width,r.height),t.viewport(0,0,r.width,r.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,_,0),t.useProgram(this.program_1),this.program_1_position_buffer==null?this.program_1_position_buffer=s(t,0,0,r.width,r.height):(this.program_1_intermediate_texture_cached_width!==r.width||this.program_1_intermediate_texture_cached_height!==r.height)&&(t.deleteBuffer(this.program_1_position_buffer),this.program_1_position_buffer=s(t,0,0,r.width,r.height));let i=this.program_1_position_buffer;c(t,this.program_1_a_position_location,i),c(t,this.program_1_a_texture_coord_location,a),t.uniform2f(this.program_1_u_resolution_location,r.width,r.height),t.uniform2f(this.program_1_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_1_MAIN_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_1_intermediate_texture_cached_width=r.width,this.program_1_intermediate_texture_cached_height=r.height,e.set("conv2d_tf1",{texture:_,width:r.width,height:r.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_tf");if(!_)return;let i=e.get("conv2d_tf1");if(!i)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let n=this.program_2_intermediate_texture;(this.program_2_intermediate_texture_cached_width!==_.width||this.program_2_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_2),this.program_2_position_buffer==null?this.program_2_position_buffer=s(t,0,0,_.width,_.height):(this.program_2_intermediate_texture_cached_width!==_.width||this.program_2_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_2_position_buffer),this.program_2_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_2_position_buffer;c(t,this.program_2_a_position_location,g),c(t,this.program_2_a_texture_coord_location,a),t.uniform2f(this.program_2_u_resolution_location,_.width,_.height),t.uniform2f(this.program_2_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_2_conv2d_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_2_conv2d_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_2_intermediate_texture_cached_width=_.width,this.program_2_intermediate_texture_cached_height=_.height,e.set("conv2d_1_tf",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_tf");if(!_)return;let i=e.get("conv2d_tf1");if(!i)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let n=this.program_3_intermediate_texture;(this.program_3_intermediate_texture_cached_width!==_.width||this.program_3_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_3),this.program_3_position_buffer==null?this.program_3_position_buffer=s(t,0,0,_.width,_.height):(this.program_3_intermediate_texture_cached_width!==_.width||this.program_3_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_3_position_buffer),this.program_3_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_3_position_buffer;c(t,this.program_3_a_position_location,g),c(t,this.program_3_a_texture_coord_location,a),t.uniform2f(this.program_3_u_resolution_location,_.width,_.height),t.uniform2f(this.program_3_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_3_conv2d_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_3_conv2d_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_3_intermediate_texture_cached_width=_.width,this.program_3_intermediate_texture_cached_height=_.height,e.set("conv2d_1_tf1",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_1_tf");if(!_)return;let i=e.get("conv2d_1_tf1");if(!i)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let n=this.program_4_intermediate_texture;(this.program_4_intermediate_texture_cached_width!==_.width||this.program_4_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_4),this.program_4_position_buffer==null?this.program_4_position_buffer=s(t,0,0,_.width,_.height):(this.program_4_intermediate_texture_cached_width!==_.width||this.program_4_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_4_position_buffer),this.program_4_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_4_position_buffer;c(t,this.program_4_a_position_location,g),c(t,this.program_4_a_texture_coord_location,a),t.uniform2f(this.program_4_u_resolution_location,_.width,_.height),t.uniform2f(this.program_4_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_4_conv2d_1_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_4_conv2d_1_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_4_intermediate_texture_cached_width=_.width,this.program_4_intermediate_texture_cached_height=_.height,e.set("conv2d_2_tf",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_1_tf");if(!_)return;let i=e.get("conv2d_1_tf1");if(!i)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let n=this.program_5_intermediate_texture;(this.program_5_intermediate_texture_cached_width!==_.width||this.program_5_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_5),this.program_5_position_buffer==null?this.program_5_position_buffer=s(t,0,0,_.width,_.height):(this.program_5_intermediate_texture_cached_width!==_.width||this.program_5_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_5_position_buffer),this.program_5_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_5_position_buffer;c(t,this.program_5_a_position_location,g),c(t,this.program_5_a_texture_coord_location,a),t.uniform2f(this.program_5_u_resolution_location,_.width,_.height),t.uniform2f(this.program_5_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_5_conv2d_1_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_5_conv2d_1_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_5_intermediate_texture_cached_width=_.width,this.program_5_intermediate_texture_cached_height=_.height,e.set("conv2d_2_tf1",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_2_tf");if(!_)return;let i=e.get("conv2d_2_tf1");if(!i)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let n=this.program_6_intermediate_texture;(this.program_6_intermediate_texture_cached_width!==_.width||this.program_6_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_6),this.program_6_position_buffer==null?this.program_6_position_buffer=s(t,0,0,_.width,_.height):(this.program_6_intermediate_texture_cached_width!==_.width||this.program_6_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_6_position_buffer),this.program_6_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_6_position_buffer;c(t,this.program_6_a_position_location,g),c(t,this.program_6_a_texture_coord_location,a),t.uniform2f(this.program_6_u_resolution_location,_.width,_.height),t.uniform2f(this.program_6_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_6_conv2d_2_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_6_conv2d_2_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_6_intermediate_texture_cached_width=_.width,this.program_6_intermediate_texture_cached_height=_.height,e.set("conv2d_3_tf",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_2_tf");if(!_)return;let i=e.get("conv2d_2_tf1");if(!i)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let n=this.program_7_intermediate_texture;(this.program_7_intermediate_texture_cached_width!==_.width||this.program_7_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_7),this.program_7_position_buffer==null?this.program_7_position_buffer=s(t,0,0,_.width,_.height):(this.program_7_intermediate_texture_cached_width!==_.width||this.program_7_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_7_position_buffer),this.program_7_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_7_position_buffer;c(t,this.program_7_a_position_location,g),c(t,this.program_7_a_texture_coord_location,a),t.uniform2f(this.program_7_u_resolution_location,_.width,_.height),t.uniform2f(this.program_7_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_7_conv2d_2_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_7_conv2d_2_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_7_intermediate_texture_cached_width=_.width,this.program_7_intermediate_texture_cached_height=_.height,e.set("conv2d_3_tf1",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_3_tf");if(!_)return;let i=e.get("conv2d_3_tf1");if(!i)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let n=this.program_8_intermediate_texture;(this.program_8_intermediate_texture_cached_width!==_.width||this.program_8_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_8),this.program_8_position_buffer==null?this.program_8_position_buffer=s(t,0,0,_.width,_.height):(this.program_8_intermediate_texture_cached_width!==_.width||this.program_8_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_8_position_buffer),this.program_8_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_8_position_buffer;c(t,this.program_8_a_position_location,g),c(t,this.program_8_a_texture_coord_location,a),t.uniform2f(this.program_8_u_resolution_location,_.width,_.height),t.uniform2f(this.program_8_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_8_conv2d_3_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_8_conv2d_3_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_8_intermediate_texture_cached_width=_.width,this.program_8_intermediate_texture_cached_height=_.height,e.set("conv2d_4_tf",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_3_tf");if(!_)return;let i=e.get("conv2d_3_tf1");if(!i)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let n=this.program_9_intermediate_texture;(this.program_9_intermediate_texture_cached_width!==_.width||this.program_9_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_9),this.program_9_position_buffer==null?this.program_9_position_buffer=s(t,0,0,_.width,_.height):(this.program_9_intermediate_texture_cached_width!==_.width||this.program_9_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_9_position_buffer),this.program_9_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_9_position_buffer;c(t,this.program_9_a_position_location,g),c(t,this.program_9_a_texture_coord_location,a),t.uniform2f(this.program_9_u_resolution_location,_.width,_.height),t.uniform2f(this.program_9_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_9_conv2d_3_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_9_conv2d_3_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_9_intermediate_texture_cached_width=_.width,this.program_9_intermediate_texture_cached_height=_.height,e.set("conv2d_4_tf1",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_4_tf");if(!_)return;let i=e.get("conv2d_4_tf1");if(!i)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let n=this.program_10_intermediate_texture;(this.program_10_intermediate_texture_cached_width!==_.width||this.program_10_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_10),this.program_10_position_buffer==null?this.program_10_position_buffer=s(t,0,0,_.width,_.height):(this.program_10_intermediate_texture_cached_width!==_.width||this.program_10_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_10_position_buffer),this.program_10_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_10_position_buffer;c(t,this.program_10_a_position_location,g),c(t,this.program_10_a_texture_coord_location,a),t.uniform2f(this.program_10_u_resolution_location,_.width,_.height),t.uniform2f(this.program_10_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_10_conv2d_4_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_10_conv2d_4_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_10_intermediate_texture_cached_width=_.width,this.program_10_intermediate_texture_cached_height=_.height,e.set("conv2d_5_tf",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_4_tf");if(!_)return;let i=e.get("conv2d_4_tf1");if(!i)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let n=this.program_11_intermediate_texture;(this.program_11_intermediate_texture_cached_width!==_.width||this.program_11_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_11),this.program_11_position_buffer==null?this.program_11_position_buffer=s(t,0,0,_.width,_.height):(this.program_11_intermediate_texture_cached_width!==_.width||this.program_11_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_11_position_buffer),this.program_11_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_11_position_buffer;c(t,this.program_11_a_position_location,g),c(t,this.program_11_a_texture_coord_location,a),t.uniform2f(this.program_11_u_resolution_location,_.width,_.height),t.uniform2f(this.program_11_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_11_conv2d_4_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_11_conv2d_4_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_11_intermediate_texture_cached_width=_.width,this.program_11_intermediate_texture_cached_height=_.height,e.set("conv2d_5_tf1",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_5_tf");if(!_)return;let i=e.get("conv2d_5_tf1");if(!i)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let n=this.program_12_intermediate_texture;(this.program_12_intermediate_texture_cached_width!==_.width||this.program_12_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_12),this.program_12_position_buffer==null?this.program_12_position_buffer=s(t,0,0,_.width,_.height):(this.program_12_intermediate_texture_cached_width!==_.width||this.program_12_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_12_position_buffer),this.program_12_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_12_position_buffer;c(t,this.program_12_a_position_location,g),c(t,this.program_12_a_texture_coord_location,a),t.uniform2f(this.program_12_u_resolution_location,_.width,_.height),t.uniform2f(this.program_12_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_12_conv2d_5_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_12_conv2d_5_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_12_intermediate_texture_cached_width=_.width,this.program_12_intermediate_texture_cached_height=_.height,e.set("conv2d_6_tf",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_5_tf");if(!_)return;let i=e.get("conv2d_5_tf1");if(!i)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let n=this.program_13_intermediate_texture;(this.program_13_intermediate_texture_cached_width!==_.width||this.program_13_intermediate_texture_cached_height!==_.height)&&T(t,n,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,n,0),t.useProgram(this.program_13),this.program_13_position_buffer==null?this.program_13_position_buffer=s(t,0,0,_.width,_.height):(this.program_13_intermediate_texture_cached_width!==_.width||this.program_13_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_13_position_buffer),this.program_13_position_buffer=s(t,0,0,_.width,_.height));let g=this.program_13_position_buffer;c(t,this.program_13_a_position_location,g),c(t,this.program_13_a_texture_coord_location,a),t.uniform2f(this.program_13_u_resolution_location,_.width,_.height),t.uniform2f(this.program_13_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_13_conv2d_5_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_13_conv2d_5_tf1_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_13_intermediate_texture_cached_width=_.width,this.program_13_intermediate_texture_cached_height=_.height,e.set("conv2d_6_tf1",{texture:n,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_1_tf");if(!_)return;let i=e.get("conv2d_1_tf1");if(!i)return;let n=e.get("conv2d_2_tf");if(!n)return;let g=e.get("conv2d_2_tf1");if(!g)return;let U=e.get("conv2d_3_tf");if(!U)return;let E=e.get("conv2d_3_tf1");if(!E)return;let b=e.get("conv2d_4_tf");if(!b)return;let L=e.get("conv2d_4_tf1");if(!L)return;let R=e.get("conv2d_5_tf");if(!R)return;let O=e.get("conv2d_5_tf1");if(!O)return;let I=e.get("conv2d_6_tf");if(!I)return;let A=e.get("conv2d_6_tf1");if(!A)return;let h=e.get("conv2d_tf");if(!h)return;let z=e.get("conv2d_tf1");if(!z)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let D=this.program_14_intermediate_texture;(this.program_14_intermediate_texture_cached_width!==h.width||this.program_14_intermediate_texture_cached_height!==h.height)&&T(t,D,h.width,h.height),t.viewport(0,0,h.width,h.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,D,0),t.useProgram(this.program_14),this.program_14_position_buffer==null?this.program_14_position_buffer=s(t,0,0,h.width,h.height):(this.program_14_intermediate_texture_cached_width!==h.width||this.program_14_intermediate_texture_cached_height!==h.height)&&(t.deleteBuffer(this.program_14_position_buffer),this.program_14_position_buffer=s(t,0,0,h.width,h.height));let P=this.program_14_position_buffer;c(t,this.program_14_a_position_location,P),c(t,this.program_14_a_texture_coord_location,a),t.uniform2f(this.program_14_u_resolution_location,h.width,h.height),t.uniform2f(this.program_14_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,h.texture),t.uniform1i(this.program_14_conv2d_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,z.texture),t.uniform1i(this.program_14_conv2d_tf1_TextureLocation,1),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_14_conv2d_1_tf_TextureLocation,2),t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_14_conv2d_1_tf1_TextureLocation,3),t.activeTexture(t.TEXTURE4),t.bindTexture(t.TEXTURE_2D,n.texture),t.uniform1i(this.program_14_conv2d_2_tf_TextureLocation,4),t.activeTexture(t.TEXTURE5),t.bindTexture(t.TEXTURE_2D,g.texture),t.uniform1i(this.program_14_conv2d_2_tf1_TextureLocation,5),t.activeTexture(t.TEXTURE6),t.bindTexture(t.TEXTURE_2D,U.texture),t.uniform1i(this.program_14_conv2d_3_tf_TextureLocation,6),t.activeTexture(t.TEXTURE7),t.bindTexture(t.TEXTURE_2D,E.texture),t.uniform1i(this.program_14_conv2d_3_tf1_TextureLocation,7),t.activeTexture(t.TEXTURE8),t.bindTexture(t.TEXTURE_2D,b.texture),t.uniform1i(this.program_14_conv2d_4_tf_TextureLocation,8),t.activeTexture(t.TEXTURE9),t.bindTexture(t.TEXTURE_2D,L.texture),t.uniform1i(this.program_14_conv2d_4_tf1_TextureLocation,9),t.activeTexture(t.TEXTURE10),t.bindTexture(t.TEXTURE_2D,R.texture),t.uniform1i(this.program_14_conv2d_5_tf_TextureLocation,10),t.activeTexture(t.TEXTURE11),t.bindTexture(t.TEXTURE_2D,O.texture),t.uniform1i(this.program_14_conv2d_5_tf1_TextureLocation,11),t.activeTexture(t.TEXTURE12),t.bindTexture(t.TEXTURE_2D,I.texture),t.uniform1i(this.program_14_conv2d_6_tf_TextureLocation,12),t.activeTexture(t.TEXTURE13),t.bindTexture(t.TEXTURE_2D,A.texture),t.uniform1i(this.program_14_conv2d_6_tf1_TextureLocation,13),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE4),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE5),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE6),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE7),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE8),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE9),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE10),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE11),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE12),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE13),t.bindTexture(t.TEXTURE_2D,null),this.program_14_intermediate_texture_cached_width=h.width,this.program_14_intermediate_texture_cached_height=h.height,e.set("conv2d_last_tf",{texture:D,width:h.width,height:h.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_1_tf");if(!_)return;let i=e.get("conv2d_1_tf1");if(!i)return;let n=e.get("conv2d_2_tf");if(!n)return;let g=e.get("conv2d_2_tf1");if(!g)return;let U=e.get("conv2d_3_tf");if(!U)return;let E=e.get("conv2d_3_tf1");if(!E)return;let b=e.get("conv2d_4_tf");if(!b)return;let L=e.get("conv2d_4_tf1");if(!L)return;let R=e.get("conv2d_5_tf");if(!R)return;let O=e.get("conv2d_5_tf1");if(!O)return;let I=e.get("conv2d_6_tf");if(!I)return;let A=e.get("conv2d_6_tf1");if(!A)return;let h=e.get("conv2d_tf");if(!h)return;let z=e.get("conv2d_tf1");if(!z)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let D=this.program_15_intermediate_texture;(this.program_15_intermediate_texture_cached_width!==h.width||this.program_15_intermediate_texture_cached_height!==h.height)&&T(t,D,h.width,h.height),t.viewport(0,0,h.width,h.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,D,0),t.useProgram(this.program_15),this.program_15_position_buffer==null?this.program_15_position_buffer=s(t,0,0,h.width,h.height):(this.program_15_intermediate_texture_cached_width!==h.width||this.program_15_intermediate_texture_cached_height!==h.height)&&(t.deleteBuffer(this.program_15_position_buffer),this.program_15_position_buffer=s(t,0,0,h.width,h.height));let P=this.program_15_position_buffer;c(t,this.program_15_a_position_location,P),c(t,this.program_15_a_texture_coord_location,a),t.uniform2f(this.program_15_u_resolution_location,h.width,h.height),t.uniform2f(this.program_15_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,h.texture),t.uniform1i(this.program_15_conv2d_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,z.texture),t.uniform1i(this.program_15_conv2d_tf1_TextureLocation,1),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_15_conv2d_1_tf_TextureLocation,2),t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_15_conv2d_1_tf1_TextureLocation,3),t.activeTexture(t.TEXTURE4),t.bindTexture(t.TEXTURE_2D,n.texture),t.uniform1i(this.program_15_conv2d_2_tf_TextureLocation,4),t.activeTexture(t.TEXTURE5),t.bindTexture(t.TEXTURE_2D,g.texture),t.uniform1i(this.program_15_conv2d_2_tf1_TextureLocation,5),t.activeTexture(t.TEXTURE6),t.bindTexture(t.TEXTURE_2D,U.texture),t.uniform1i(this.program_15_conv2d_3_tf_TextureLocation,6),t.activeTexture(t.TEXTURE7),t.bindTexture(t.TEXTURE_2D,E.texture),t.uniform1i(this.program_15_conv2d_3_tf1_TextureLocation,7),t.activeTexture(t.TEXTURE8),t.bindTexture(t.TEXTURE_2D,b.texture),t.uniform1i(this.program_15_conv2d_4_tf_TextureLocation,8),t.activeTexture(t.TEXTURE9),t.bindTexture(t.TEXTURE_2D,L.texture),t.uniform1i(this.program_15_conv2d_4_tf1_TextureLocation,9),t.activeTexture(t.TEXTURE10),t.bindTexture(t.TEXTURE_2D,R.texture),t.uniform1i(this.program_15_conv2d_5_tf_TextureLocation,10),t.activeTexture(t.TEXTURE11),t.bindTexture(t.TEXTURE_2D,O.texture),t.uniform1i(this.program_15_conv2d_5_tf1_TextureLocation,11),t.activeTexture(t.TEXTURE12),t.bindTexture(t.TEXTURE_2D,I.texture),t.uniform1i(this.program_15_conv2d_6_tf_TextureLocation,12),t.activeTexture(t.TEXTURE13),t.bindTexture(t.TEXTURE_2D,A.texture),t.uniform1i(this.program_15_conv2d_6_tf1_TextureLocation,13),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE4),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE5),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE6),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE7),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE8),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE9),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE10),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE11),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE12),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE13),t.bindTexture(t.TEXTURE_2D,null),this.program_15_intermediate_texture_cached_width=h.width,this.program_15_intermediate_texture_cached_height=h.height,e.set("conv2d_last_tf1",{texture:D,width:h.width,height:h.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_1_tf");if(!_)return;let i=e.get("conv2d_1_tf1");if(!i)return;let n=e.get("conv2d_2_tf");if(!n)return;let g=e.get("conv2d_2_tf1");if(!g)return;let U=e.get("conv2d_3_tf");if(!U)return;let E=e.get("conv2d_3_tf1");if(!E)return;let b=e.get("conv2d_4_tf");if(!b)return;let L=e.get("conv2d_4_tf1");if(!L)return;let R=e.get("conv2d_5_tf");if(!R)return;let O=e.get("conv2d_5_tf1");if(!O)return;let I=e.get("conv2d_6_tf");if(!I)return;let A=e.get("conv2d_6_tf1");if(!A)return;let h=e.get("conv2d_tf");if(!h)return;let z=e.get("conv2d_tf1");if(!z)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let D=this.program_16_intermediate_texture;(this.program_16_intermediate_texture_cached_width!==h.width||this.program_16_intermediate_texture_cached_height!==h.height)&&T(t,D,h.width,h.height),t.viewport(0,0,h.width,h.height),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,D,0),t.useProgram(this.program_16),this.program_16_position_buffer==null?this.program_16_position_buffer=s(t,0,0,h.width,h.height):(this.program_16_intermediate_texture_cached_width!==h.width||this.program_16_intermediate_texture_cached_height!==h.height)&&(t.deleteBuffer(this.program_16_position_buffer),this.program_16_position_buffer=s(t,0,0,h.width,h.height));let P=this.program_16_position_buffer;c(t,this.program_16_a_position_location,P),c(t,this.program_16_a_texture_coord_location,a),t.uniform2f(this.program_16_u_resolution_location,h.width,h.height),t.uniform2f(this.program_16_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,h.texture),t.uniform1i(this.program_16_conv2d_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,z.texture),t.uniform1i(this.program_16_conv2d_tf1_TextureLocation,1),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_16_conv2d_1_tf_TextureLocation,2),t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_16_conv2d_1_tf1_TextureLocation,3),t.activeTexture(t.TEXTURE4),t.bindTexture(t.TEXTURE_2D,n.texture),t.uniform1i(this.program_16_conv2d_2_tf_TextureLocation,4),t.activeTexture(t.TEXTURE5),t.bindTexture(t.TEXTURE_2D,g.texture),t.uniform1i(this.program_16_conv2d_2_tf1_TextureLocation,5),t.activeTexture(t.TEXTURE6),t.bindTexture(t.TEXTURE_2D,U.texture),t.uniform1i(this.program_16_conv2d_3_tf_TextureLocation,6),t.activeTexture(t.TEXTURE7),t.bindTexture(t.TEXTURE_2D,E.texture),t.uniform1i(this.program_16_conv2d_3_tf1_TextureLocation,7),t.activeTexture(t.TEXTURE8),t.bindTexture(t.TEXTURE_2D,b.texture),t.uniform1i(this.program_16_conv2d_4_tf_TextureLocation,8),t.activeTexture(t.TEXTURE9),t.bindTexture(t.TEXTURE_2D,L.texture),t.uniform1i(this.program_16_conv2d_4_tf1_TextureLocation,9),t.activeTexture(t.TEXTURE10),t.bindTexture(t.TEXTURE_2D,R.texture),t.uniform1i(this.program_16_conv2d_5_tf_TextureLocation,10),t.activeTexture(t.TEXTURE11),t.bindTexture(t.TEXTURE_2D,O.texture),t.uniform1i(this.program_16_conv2d_5_tf1_TextureLocation,11),t.activeTexture(t.TEXTURE12),t.bindTexture(t.TEXTURE_2D,I.texture),t.uniform1i(this.program_16_conv2d_6_tf_TextureLocation,12),t.activeTexture(t.TEXTURE13),t.bindTexture(t.TEXTURE_2D,A.texture),t.uniform1i(this.program_16_conv2d_6_tf1_TextureLocation,13),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE4),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE5),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE6),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE7),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE8),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE9),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE10),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE11),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE12),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE13),t.bindTexture(t.TEXTURE_2D,null),this.program_16_intermediate_texture_cached_width=h.width,this.program_16_intermediate_texture_cached_height=h.height,e.set("conv2d_last_tf2",{texture:D,width:h.width,height:h.height})}}{if(!e.get("MAIN"))return;let r=e.get("MAIN");if(!r||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let _=e.get("conv2d_last_tf");if(!_)return;let i=e.get("conv2d_last_tf1");if(!i)return;let n=e.get("conv2d_last_tf2");if(!n)return;if(o.width/r.width>1.2&&o.height/r.height>1.2){let g=this.program_17_intermediate_texture;(this.program_17_intermediate_texture_cached_width!==_.width*2||this.program_17_intermediate_texture_cached_height!==_.height*2)&&T(t,g,_.width*2,_.height*2),t.viewport(0,0,_.width*2,_.height*2),t.bindFramebuffer(t.FRAMEBUFFER,u),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,g,0),t.useProgram(this.program_17),this.program_17_position_buffer==null?this.program_17_position_buffer=s(t,0,0,_.width*2,_.height*2):(this.program_17_intermediate_texture_cached_width!==_.width*2||this.program_17_intermediate_texture_cached_height!==_.height*2)&&(t.deleteBuffer(this.program_17_position_buffer),this.program_17_position_buffer=s(t,0,0,_.width*2,_.height*2));let U=this.program_17_position_buffer;c(t,this.program_17_a_position_location,U),c(t,this.program_17_a_texture_coord_location,a),t.uniform2f(this.program_17_u_resolution_location,_.width*2,_.height*2),t.uniform2f(this.program_17_u_texture_size_location,r.width,r.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_17_MAIN_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_17_conv2d_last_tf_TextureLocation,1),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,i.texture),t.uniform1i(this.program_17_conv2d_last_tf1_TextureLocation,2),t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,n.texture),t.uniform1i(this.program_17_conv2d_last_tf2_TextureLocation,3),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,null),this.program_17_intermediate_texture_cached_width=_.width*2,this.program_17_intermediate_texture_cached_height=_.height*2,e.set("MAIN",{texture:g,width:_.width*2,height:_.height*2})}}}}hook_PREKERNEL(e,u){let t=this.gl;this.texcoordBuffer}};var I1={balanced:[y,V,H],quality:[y,B,S]};export{I1 as PROFILES,W as VideoUpscaler};
