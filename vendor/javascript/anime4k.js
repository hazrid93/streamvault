 ...
 * MIT License. Slim bundle for StreamVault: VideoUpscaler + SIMPLE_M_2X profile
 * (ClampHighlights, Restore CNN M, Upscale CNN x2 M); other shaders tree-shaken.
 * Rebuilt with esbuild from anime4k.js@1.1.3 (npm). */
var F=(i,e,n)=>{let t=i.createShader(e);return t?(i.shaderSource(t,n),i.compileShader(t),i.getShaderParameter(t,i.COMPILE_STATUS)?t:(console.warn(i.getShaderInfoLog(t)),i.deleteShader(t),null)):null},g=(i,e)=>F(i,i.VERTEX_SHADER,e),l=(i,e)=>F(i,i.FRAGMENT_SHADER,e),x=(i,e,n)=>{let t=i.createProgram();return t?(i.attachShader(t,e),i.attachShader(t,n),i.linkProgram(t),i.getProgramParameter(t,i.LINK_STATUS)?(i.deleteShader(e),i.deleteShader(n),t):(console.warn(i.getProgramInfoLog(t)),i.deleteProgram(t),null)):null},p=(i,e)=>{let n=i.createTexture();return n?(i.bindTexture(i.TEXTURE_2D,n),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,e),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MAG_FILTER,e),i.bindTexture(i.TEXTURE_2D,null),n):null},T=(i,e,n,t)=>{let a=i.getExtension("OES_texture_half_float");i.bindTexture(i.TEXTURE_2D,e),i.texImage2D(i.TEXTURE_2D,0,i.RGBA,n,t,0,i.RGBA,a?.HALF_FLOAT_OES??i.FLOAT,null),i.bindTexture(i.TEXTURE_2D,null)},m=(i,e,n,t,a)=>{let s=i.createBuffer();return s?(i.bindBuffer(i.ARRAY_BUFFER,s),i.bufferData(i.ARRAY_BUFFER,new Float32Array([e,n,t,n,e,a,e,a,t,n,t,a]),i.STATIC_DRAW),i.bindBuffer(i.ARRAY_BUFFER,null),s):null},h=(i,e,n)=>{i.bindBuffer(i.ARRAY_BUFFER,n),i.vertexAttribPointer(e,2,i.FLOAT,!1,0,0),i.bindBuffer(i.ARRAY_BUFFER,null)};var z=`
...
`,R=class{gl;program;resolutionLocation;sourceTextureLocation;aPositionLocation;aTextureCoordLocation;texcoordBuffer;positionBuffer=null;cachedWidth=null;cachedHeight=null;constructor(e){this.gl=e,this.program=x(e,g(e,z),l(e,X)),this.texcoordBuffer=m(e,0,0,1,1),this.resolutionLocation=e.getUniformLocation(this.program,"u_resolution"),this.sourceTextureLocation=e.getUniformLocation(this.program,"u_image"),this.aPositionLocation=e.getAttribLocation(this.program,"a_position"),e.enableVertexAttribArray(this.aPositionLocation),this.aTextureCoordLocation=e.getAttribLocation(this.program,"a_texture_coord"),e.enableVertexAttribArray(this.aTextureCoordLocation)}destroy(){let e=this.gl;this.texcoordBuffer!=null&&e.deleteBuffer(this.texcoordBuffer),this.positionBuffer!=null&&e.deleteBuffer(this.positionBuffer)}render(e,n,t){let a=this.gl,s=this.texcoordBuffer;if(!s)return;let{texture:_}=e;{a.viewport(0,0,n,t),a.bindFramebuffer(a.FRAMEBUFFER,null),a.activeTexture(a.TEXTURE0),a.bindTexture(a.TEXTURE_2D,_),a.useProgram(this.program),this.positionBuffer==null?this.positionBuffer=m(a,0,0,n,t):(this.cachedWidth!==n||this.cachedHeight!==t)&&(a.deleteBuffer(this.positionBuffer),this.positionBuffer=m(a,0,0,n,t));let c=this.positionBuffer;h(a,this.aPositionLocation,c),h(a,this.aTextureCoordLocation,s),a.uniform2f(this.resolutionLocation,n,t),a.uniform1i(this.sourceTextureLocation,0),a.drawArrays(a.TRIANGLES,0,6),this.cachedWidth=n,this.cachedHeight=t}}};var G=(i,e)=>e!=null?!1:typeof i?.requestVideoFrameCallback=="function",S=(i,e,n)=>e?.requestVideoFrameCallback&&G(e,n)?e.requestVideoFrameCallback(i):requestAnimationFrame(i),B=(i,e,n)=>{if(e?.cancelVideoFrameCallback&&G(e,n)){e.cancelVideoFrameCallback(i);return}cancelAnimationFrame(i)},I=class i{video=null;canvas=null;gl=null;scale=null;config;textures=new Map;in_texture=null;native_texture=null;output_texture=null;framebuffer=null;programs=null;passthrough=null;upscaleHandler=this.upscale.bind(this);upscaleTimer=null;running=!1;upscaleTime=0;fps;supported;constructor(e,n){this.supported=i.isSupported(),this.config=e,this.fps=n}static isSupported(){let n=document.createElement("canvas").getContext("webgl");return!(!n||n.getExtension("OES_texture_float")==null||n.getExtension("OES_texture_float_linear")==null)}start(){this.running=!0,this.upscaleTime=0,this.upscale()}stop(){this.running=!1,this.upscaleTime=0,this.canvas&&(this.canvas.style.visibility="hidden"),this.upscaleTimer!=null&&(B(this.upscaleTimer,this.video??void 0,this.fps),this.upscaleTimer=null)}upscale(){if(!this.supported||!this.video||!this.canvas||!this.gl||!this.framebuffer||!this.programs||!this.passthrough||!this.running)return;this.adjustCanvasSize();let e=performance.now();if(!G(this.video,this.fps)&&(e-this.upscaleTime)*(this.fps??Number.POSITIVE_INFINITY)<1e3){this.upscaleTimer=S(this.upscaleHandler,this.video,this.fps);return}this.upscaleTime=e;let n=this.gl,t=this.framebuffer,a=this.in_texture;if(!a)return;n.bindTexture(n.TEXTURE_2D,a),n.texImage2D(n.TEXTURE_2D,0,n.RGBA,n.RGBA,n.UNSIGNED_BYTE,this.video),n.bindTexture(n.TEXTURE_2D,null);let s=this.native_texture;if(!s)return;let _=this.output_texture;if(!_)return;let c=this.video.videoWidth,o=this.video.videoHeight,r=this.canvas.width,u=this.canvas.height;{let f=this.textures.get("NATIVE");(f==null||f.width!==c||f.height!==o)&&this.textures.set("NATIVE",{texture:s,width:c,height:o})}{let f=this.textures.get("OUTPUT");(f==null||f.width!==r||f.height!==u)&&this.textures.set("OUTPUT",{texture:_,width:r,height:u})}{let f=this.textures.get("MAIN");(f==null||f.width!==c||f.height!==o)&&this.textures.set("MAIN",{texture:a,width:c,height:o})}if(this.programs.forEach(f=>f.hook_MAIN(this.textures,t)),this.textures.has("MAIN")){let f=this.textures.get("MAIN");this.textures.set("PREKERNEL",f),this.textures.delete("MAIN"),this.programs.forEach(b=>b.hook_PREKERNEL(this.textures,t))}this.passthrough.render(this.textures.get("PREKERNEL"),r,u),n.flush(),this.canvas.style.visibility="visible",this.upscaleTimer=S(this.upscaleHandler,this.video,this.fps)}attachVideo(e,n){if(this.video=e,this.canvas=n,this.gl=this.canvas.getContext("webgl",{premultipliedAlpha:!1,stencil:!1,depth:!1}),this.gl&&this.gl.getExtension("OES_texture_float")&&this.gl.getExtension("OES_texture_float_linear")&&this.gl.getExtension("EXT_color_buffer_half_float")){let t=this.gl;t.disable(t.DEPTH_TEST),t.disable(t.STENCIL_TEST),t.clearColor(0,0,0,0),t.clear(t.COLOR_BUFFER_BIT),this.framebuffer=t.createFramebuffer(),this.in_texture=p(t,t.LINEAR),this.native_texture=p(t,t.LINEAR),this.output_texture=p(t,t.LINEAR),this.programs=this.config.map(a=>new a(t)),this.scale=null,this.passthrough=new R(t),this.adjustCanvasSize()}else this.detachVideo()}detachVideo(){this.stop(),(this.programs??[]).forEach(e=>e.destroy()),this.passthrough?.destroy(),this.passthrough=null,this.gl?.deleteFramebuffer(this.framebuffer),this.gl?.deleteTexture(this.in_texture),this.gl?.deleteTexture(this.native_texture),this.gl?.deleteTexture(this.output_texture),this.in_texture=this.native_texture=this.output_texture=null,this.gl=null,this.framebuffer=null,this.canvas&&(this.canvas.style.visibility="hidden"),this.video=null,this.canvas=null}adjustCanvasSize(){if(!this.video||!this.canvas)return;if(this.scale==null){let t=1,a=1;for(let s of this.programs??[]){let[_,c]=s.magnification();t*=_,a*=c}this.scale=[t,a]}let e=this.video.videoWidth*this.scale[0],n=this.video.videoHeight*this.scale[1];(this.canvas.width!==e||this.canvas.height!==n)&&(this.canvas.width=e,this.canvas.height=n),this.canvas.style.pointerEvents="none"}};var E=class{magnification(){return[1,1]}hook_MAIN(e,n){}hook_PREKERNEL(e,n){}};var P=`
precision highp float;
...
`,M=class extends E{gl;texcoordBuffer;program_0;program_1;program_2;program_3;program_4;program_5;program_6;program_7;program_8;program_0_intermediate_texture;program_1_intermediate_texture;program_2_intermediate_texture;program_3_intermediate_texture;program_4_intermediate_texture;program_5_intermediate_texture;program_6_intermediate_texture;program_7_intermediate_texture;program_8_intermediate_texture;program_0_intermediate_texture_cached_width;program_1_intermediate_texture_cached_width;program_2_intermediate_texture_cached_width;program_3_intermediate_texture_cached_width;program_4_intermediate_texture_cached_width;program_5_intermediate_texture_cached_width;program_6_intermediate_texture_cached_width;program_7_intermediate_texture_cached_width;program_8_intermediate_texture_cached_width;program_0_intermediate_texture_cached_height;program_1_intermediate_texture_cached_height;program_2_intermediate_texture_cached_height;program_3_intermediate_texture_cached_height;program_4_intermediate_texture_cached_height;program_5_intermediate_texture_cached_height;program_6_intermediate_texture_cached_height;program_7_intermediate_texture_cached_height;program_8_intermediate_texture_cached_height;program_0_a_position_location;program_1_a_position_location;program_2_a_position_location;program_3_a_position_location;program_4_a_position_location;program_5_a_position_location;program_6_a_position_location;program_7_a_position_location;program_8_a_position_location;program_0_a_texture_coord_location;program_1_a_texture_coord_location;program_2_a_texture_coord_location;program_3_a_texture_coord_location;program_4_a_texture_coord_location;program_5_a_texture_coord_location;program_6_a_texture_coord_location;program_7_a_texture_coord_location;program_8_a_texture_coord_location;program_0_u_resolution_location;program_1_u_resolution_location;program_2_u_resolution_location;program_3_u_resolution_location;program_4_u_resolution_location;program_5_u_resolution_location;program_6_u_resolution_location;program_7_u_resolution_location;program_8_u_resolution_location;program_0_u_texture_size_location;program_1_u_texture_size_location;program_2_u_texture_size_location;program_3_u_texture_size_location;program_4_u_texture_size_location;program_5_u_texture_size_location;program_6_u_texture_size_location;program_7_u_texture_size_location;program_8_u_texture_size_location;program_0_MAIN_TextureLocation;program_1_conv2d_tf_TextureLocation;program_2_conv2d_1_tf_TextureLocation;program_3_conv2d_2_tf_TextureLocation;program_4_conv2d_3_tf_TextureLocation;program_5_conv2d_4_tf_TextureLocation;program_6_conv2d_5_tf_TextureLocation;program_7_conv2d_tf_TextureLocation;program_7_conv2d_1_tf_TextureLocation;program_7_conv2d_2_tf_TextureLocation;program_7_conv2d_3_tf_TextureLocation;program_7_conv2d_4_tf_TextureLocation;program_7_conv2d_5_tf_TextureLocation;program_7_conv2d_6_tf_TextureLocation;program_8_MAIN_TextureLocation;program_8_conv2d_last_tf_TextureLocation;program_0_position_buffer;program_1_position_buffer;program_2_position_buffer;program_3_position_buffer;program_4_position_buffer;program_5_position_buffer;program_6_position_buffer;program_7_position_buffer;program_8_position_buffer;constructor(e){super(),this.gl=e,this.texcoordBuffer=m(e,0,0,1,1),this.program_0=x(e,g(e,A),l(e,Q)),this.program_1=x(e,g(e,A),l(e,J)),this.program_2=x(e,g(e,A),l(e,$)),this.program_3=x(e,g(e,A),l(e,t0)),this.program_4=x(e,g(e,A),l(e,e0)),this.program_5=x(e,g(e,A),l(e,r0)),this.program_6=x(e,g(e,A),l(e,_0)),this.program_7=x(e,g(e,A),l(e,o0)),this.program_8=x(e,g(e,A),l(e,i0)),this.program_0_intermediate_texture=p(e,e.NEAREST),this.program_1_intermediate_texture=p(e,e.NEAREST),this.program_2_intermediate_texture=p(e,e.NEAREST),this.program_3_intermediate_texture=p(e,e.NEAREST),this.program_4_intermediate_texture=p(e,e.NEAREST),this.program_5_intermediate_texture=p(e,e.NEAREST),this.program_6_intermediate_texture=p(e,e.NEAREST),this.program_7_intermediate_texture=p(e,e.NEAREST),this.program_8_intermediate_texture=p(e,e.NEAREST),this.program_0_intermediate_texture_cached_width=null,this.program_1_intermediate_texture_cached_width=null,this.program_2_intermediate_texture_cached_width=null,this.program_3_intermediate_texture_cached_width=null,this.program_4_intermediate_texture_cached_width=null,this.program_5_intermediate_texture_cached_width=null,this.program_6_intermediate_texture_cached_width=null,this.program_7_intermediate_texture_cached_width=null,this.program_8_intermediate_texture_cached_width=null,this.program_0_intermediate_texture_cached_height=null,this.program_1_intermediate_texture_cached_height=null,this.program_2_intermediate_texture_cached_height=null,this.program_3_intermediate_texture_cached_height=null,this.program_4_intermediate_texture_cached_height=null,this.program_5_intermediate_texture_cached_height=null,this.program_6_intermediate_texture_cached_height=null,this.program_7_intermediate_texture_cached_height=null,this.program_8_intermediate_texture_cached_height=null,this.program_0_a_position_location=e.getAttribLocation(this.program_0,"a_position"),e.enableVertexAttribArray(this.program_0_a_position_location),this.program_1_a_position_location=e.getAttribLocation(this.program_1,"a_position"),e.enableVertexAttribArray(this.program_1_a_position_location),this.program_2_a_position_location=e.getAttribLocation(this.program_2,"a_position"),e.enableVertexAttribArray(this.program_2_a_position_location),this.program_3_a_position_location=e.getAttribLocation(this.program_3,"a_position"),e.enableVertexAttribArray(this.program_3_a_position_location),this.program_4_a_position_location=e.getAttribLocation(this.program_4,"a_position"),e.enableVertexAttribArray(this.program_4_a_position_location),this.program_5_a_position_location=e.getAttribLocation(this.program_5,"a_position"),e.enableVertexAttribArray(this.program_5_a_position_location),this.program_6_a_position_location=e.getAttribLocation(this.program_6,"a_position"),e.enableVertexAttribArray(this.program_6_a_position_location),this.program_7_a_position_location=e.getAttribLocation(this.program_7,"a_position"),e.enableVertexAttribArray(this.program_7_a_position_location),this.program_8_a_position_location=e.getAttribLocation(this.program_8,"a_position"),e.enableVertexAttribArray(this.program_8_a_position_location),this.program_0_a_texture_coord_location=e.getAttribLocation(this.program_0,"a_texture_coord"),e.enableVertexAttribArray(this.program_0_a_texture_coord_location),this.program_1_a_texture_coord_location=e.getAttribLocation(this.program_1,"a_texture_coord"),e.enableVertexAttribArray(this.program_1_a_texture_coord_location),this.program_2_a_texture_coord_location=e.getAttribLocation(this.program_2,"a_texture_coord"),e.enableVertexAttribArray(this.program_2_a_texture_coord_location),this.program_3_a_texture_coord_location=e.getAttribLocation(this.program_3,"a_texture_coord"),e.enableVertexAttribArray(this.program_3_a_texture_coord_location),this.program_4_a_texture_coord_location=e.getAttribLocation(this.program_4,"a_texture_coord"),e.enableVertexAttribArray(this.program_4_a_texture_coord_location),this.program_5_a_texture_coord_location=e.getAttribLocation(this.program_5,"a_texture_coord"),e.enableVertexAttribArray(this.program_5_a_texture_coord_location),this.program_6_a_texture_coord_location=e.getAttribLocation(this.program_6,"a_texture_coord"),e.enableVertexAttribArray(this.program_6_a_texture_coord_location),this.program_7_a_texture_coord_location=e.getAttribLocation(this.program_7,"a_texture_coord"),e.enableVertexAttribArray(this.program_7_a_texture_coord_location),this.program_8_a_texture_coord_location=e.getAttribLocation(this.program_8,"a_texture_coord"),e.enableVertexAttribArray(this.program_8_a_texture_coord_location),this.program_0_u_resolution_location=e.getUniformLocation(this.program_0,"u_resolution"),this.program_1_u_resolution_location=e.getUniformLocation(this.program_1,"u_resolution"),this.program_2_u_resolution_location=e.getUniformLocation(this.program_2,"u_resolution"),this.program_3_u_resolution_location=e.getUniformLocation(this.program_3,"u_resolution"),this.program_4_u_resolution_location=e.getUniformLocation(this.program_4,"u_resolution"),this.program_5_u_resolution_location=e.getUniformLocation(this.program_5,"u_resolution"),this.program_6_u_resolution_location=e.getUniformLocation(this.program_6,"u_resolution"),this.program_7_u_resolution_location=e.getUniformLocation(this.program_7,"u_resolution"),this.program_8_u_resolution_location=e.getUniformLocation(this.program_8,"u_resolution"),this.program_0_u_texture_size_location=e.getUniformLocation(this.program_0,"u_texture_size"),this.program_1_u_texture_size_location=e.getUniformLocation(this.program_1,"u_texture_size"),this.program_2_u_texture_size_location=e.getUniformLocation(this.program_2,"u_texture_size"),this.program_3_u_texture_size_location=e.getUniformLocation(this.program_3,"u_texture_size"),this.program_4_u_texture_size_location=e.getUniformLocation(this.program_4,"u_texture_size"),this.program_5_u_texture_size_location=e.getUniformLocation(this.program_5,"u_texture_size"),this.program_6_u_texture_size_location=e.getUniformLocation(this.program_6,"u_texture_size"),this.program_7_u_texture_size_location=e.getUniformLocation(this.program_7,"u_texture_size"),this.program_8_u_texture_size_location=e.getUniformLocation(this.program_8,"u_texture_size"),this.program_0_MAIN_TextureLocation=e.getUniformLocation(this.program_0,"MAIN"),this.program_1_conv2d_tf_TextureLocation=e.getUniformLocation(this.program_1,"conv2d_tf"),this.program_2_conv2d_1_tf_TextureLocation=e.getUniformLocation(this.program_2,"conv2d_1_tf"),this.program_3_conv2d_2_tf_TextureLocation=e.getUniformLocation(this.program_3,"conv2d_2_tf"),this.program_4_conv2d_3_tf_TextureLocation=e.getUniformLocation(this.program_4,"conv2d_3_tf"),this.program_5_conv2d_4_tf_TextureLocation=e.getUniformLocation(this.program_5,"conv2d_4_tf"),this.program_6_conv2d_5_tf_TextureLocation=e.getUniformLocation(this.program_6,"conv2d_5_tf"),this.program_7_conv2d_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_tf"),this.program_7_conv2d_1_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_1_tf"),this.program_7_conv2d_2_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_2_tf"),this.program_7_conv2d_3_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_3_tf"),this.program_7_conv2d_4_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_4_tf"),this.program_7_conv2d_5_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_5_tf"),this.program_7_conv2d_6_tf_TextureLocation=e.getUniformLocation(this.program_7,"conv2d_6_tf"),this.program_8_MAIN_TextureLocation=e.getUniformLocation(this.program_8,"MAIN"),this.program_8_conv2d_last_tf_TextureLocation=e.getUniformLocation(this.program_8,"conv2d_last_tf"),this.program_0_position_buffer=null,this.program_1_position_buffer=null,this.program_2_position_buffer=null,this.program_3_position_buffer=null,this.program_4_position_buffer=null,this.program_5_position_buffer=null,this.program_6_position_buffer=null,this.program_7_position_buffer=null,this.program_8_position_buffer=null}destroy(){let e=this.gl;this.texcoordBuffer!=null&&e.deleteBuffer(this.texcoordBuffer),this.program_0_intermediate_texture!=null&&e.deleteTexture(this.program_0_intermediate_texture),this.program_0_position_buffer!=null&&e.deleteBuffer(this.program_0_position_buffer),this.program_0!=null&&e.deleteProgram(this.program_0),this.program_1_intermediate_texture!=null&&e.deleteTexture(this.program_1_intermediate_texture),this.program_1_position_buffer!=null&&e.deleteBuffer(this.program_1_position_buffer),this.program_1!=null&&e.deleteProgram(this.program_1),this.program_2_intermediate_texture!=null&&e.deleteTexture(this.program_2_intermediate_texture),this.program_2_position_buffer!=null&&e.deleteBuffer(this.program_2_position_buffer),this.program_2!=null&&e.deleteProgram(this.program_2),this.program_3_intermediate_texture!=null&&e.deleteTexture(this.program_3_intermediate_texture),this.program_3_position_buffer!=null&&e.deleteBuffer(this.program_3_position_buffer),this.program_3!=null&&e.deleteProgram(this.program_3),this.program_4_intermediate_texture!=null&&e.deleteTexture(this.program_4_intermediate_texture),this.program_4_position_buffer!=null&&e.deleteBuffer(this.program_4_position_buffer),this.program_4!=null&&e.deleteProgram(this.program_4),this.program_5_intermediate_texture!=null&&e.deleteTexture(this.program_5_intermediate_texture),this.program_5_position_buffer!=null&&e.deleteBuffer(this.program_5_position_buffer),this.program_5!=null&&e.deleteProgram(this.program_5),this.program_6_intermediate_texture!=null&&e.deleteTexture(this.program_6_intermediate_texture),this.program_6_position_buffer!=null&&e.deleteBuffer(this.program_6_position_buffer),this.program_6!=null&&e.deleteProgram(this.program_6),this.program_7_intermediate_texture!=null&&e.deleteTexture(this.program_7_intermediate_texture),this.program_7_position_buffer!=null&&e.deleteBuffer(this.program_7_position_buffer),this.program_7!=null&&e.deleteProgram(this.program_7),this.program_8_intermediate_texture!=null&&e.deleteTexture(this.program_8_intermediate_texture),this.program_8_position_buffer!=null&&e.deleteBuffer(this.program_8_position_buffer),this.program_8!=null&&e.deleteProgram(this.program_8)}magnification(){let e=new Map([["MAIN",{width:1,height:1}],["NATIVE",{width:1,height:1}],["OUTPUT",{width:1,height:1}]]);{if(!e.get("MAIN"))return[1,1];let s=e.get("MAIN");if(!s)return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];e.set("conv2d_tf",{width:s.width,height:s.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_tf");if(!o)return[1,1];e.set("conv2d_1_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_1_tf");if(!o)return[1,1];e.set("conv2d_2_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_2_tf");if(!o)return[1,1];e.set("conv2d_3_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_3_tf");if(!o)return[1,1];e.set("conv2d_4_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_4_tf");if(!o)return[1,1];e.set("conv2d_5_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_5_tf");if(!o)return[1,1];e.set("conv2d_6_tf",{width:o.width,height:o.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];if(!e.get("conv2d_1_tf"))return[1,1];if(!e.get("conv2d_2_tf"))return[1,1];if(!e.get("conv2d_3_tf"))return[1,1];if(!e.get("conv2d_4_tf"))return[1,1];if(!e.get("conv2d_5_tf"))return[1,1];if(!e.get("conv2d_6_tf"))return[1,1];let v=e.get("conv2d_tf");if(!v)return[1,1];e.set("conv2d_last_tf",{width:v.width,height:v.height})}{if(!e.get("MAIN"))return[1,1];if(!e.get("MAIN"))return[1,1];if(!e.get("NATIVE"))return[1,1];if(!e.get("OUTPUT"))return[1,1];let o=e.get("conv2d_last_tf");if(!o)return[1,1];e.set("MAIN",{width:o.width*2,height:o.height*2})}let n=e.get("MAIN")?.width??1,t=e.get("MAIN")?.height??1;return[n,t]}hook_MAIN(e,n){let t=this.gl,a=this.texcoordBuffer;if(a){{if(!e.get("MAIN"))return;let _=e.get("MAIN");if(!_||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;if(o.width/_.width>1.2&&o.height/_.height>1.2){let r=this.program_0_intermediate_texture;(this.program_0_intermediate_texture_cached_width!==_.width||this.program_0_intermediate_texture_cached_height!==_.height)&&T(t,r,_.width,_.height),t.viewport(0,0,_.width,_.height),t.bindFramebuffer(t.FRAMEBUFFER,n),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,r,0),t.useProgram(this.program_0),this.program_0_position_buffer==null?this.program_0_position_buffer=m(t,0,0,_.width,_.height):(this.program_0_intermediate_texture_cached_width!==_.width||this.program_0_intermediate_texture_cached_height!==_.height)&&(t.deleteBuffer(this.program_0_position_buffer),this.program_0_position_buffer=m(t,0,0,_.width,_.height));let u=this.program_0_position_buffer;h(t,this.program_0_a_position_location,u),h(t,this.program_0_a_texture_coord_location,a),t.uniform2f(this.program_0_u_resolution_location,_.width,_.height),t.uniform2f(this.program_0_u_texture_size_location,_.width,_.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_0_MAIN_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_0_intermediate_texture_cached_width=_.width,this.program_0_intermediate_texture_cached_height=_.height,e.set("conv2d_tf",{texture:r,width:_.width,height:_.height})}}{if(!e.get("MAIN"))return;let _=e.get("MAIN");if(!_||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let r=e.get("conv2d_tf");if(!r)return;if(o.width/_.width>1.2&&o.height/_.height>1.2){let u=this.program_1_intermediate_texture;(this.program_1_intermediate_texture_cached_width!==r.width||this.program_1_intermediate_texture_cached_height!==r.height)&&T(t,u,r.width,r.height),t.viewport(0,0,r.width,r.height),t.bindFramebuffer(t.FRAMEBUFFER,n),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,u,0),t.useProgram(this.program_1),this.program_1_position_buffer==null?this.program_1_position_buffer=m(t,0,0,r.width,r.height):(this.program_1_intermediate_texture_cached_width!==r.width||this.program_1_intermediate_texture_cached_height!==r.height)&&(t.deleteBuffer(this.program_1_position_buffer),this.program_1_position_buffer=m(t,0,0,r.width,r.height));let f=this.program_1_position_buffer;h(t,this.program_1_a_position_location,f),h(t,this.program_1_a_texture_coord_location,a),t.uniform2f(this.program_1_u_resolution_location,r.width,r.height),t.uniform2f(this.program_1_u_texture_size_location,_.width,_.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_1_conv2d_tf_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_1_intermediate_texture_cached_width=r.width,this.program_1_intermediate_texture_cached_height=r.height,e.set("conv2d_1_tf",{texture:u,width:r.width,height:r.height})}}{if(!e.get("MAIN"))return;let _=e.get("MAIN");if(!_||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let r=e.get("conv2d_1_tf");if(!r)return;if(o.width/_.width>1.2&&o.height/_.height>1.2){let u=this.program_2_intermediate_texture;(this.program_2_intermediate_texture_cached_width!==r.width||this.program_2_intermediate_texture_cached_height!==r.height)&&T(t,u,r.width,r.height),t.viewport(0,0,r.width,r.height),t.bindFramebuffer(t.FRAMEBUFFER,n),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,u,0),t.useProgram(this.program_2),this.program_2_position_buffer==null?this.program_2_position_buffer=m(t,0,0,r.width,r.height):(this.program_2_intermediate_texture_cached_width!==r.width||this.program_2_intermediate_texture_cached_height!==r.height)&&(t.deleteBuffer(this.program_2_position_buffer),this.program_2_position_buffer=m(t,0,0,r.width,r.height));let f=this.program_2_position_buffer;h(t,this.program_2_a_position_location,f),h(t,this.program_2_a_texture_coord_location,a),t.uniform2f(this.program_2_u_resolution_location,r.width,r.height),t.uniform2f(this.program_2_u_texture_size_location,_.width,_.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_2_conv2d_1_tf_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_2_intermediate_texture_cached_width=r.width,this.program_2_intermediate_texture_cached_height=r.height,e.set("conv2d_2_tf",{texture:u,width:r.width,height:r.height})}}{if(!e.get("MAIN"))return;let _=e.get("MAIN");if(!_||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let r=e.get("conv2d_2_tf");if(!r)return;if(o.width/_.width>1.2&&o.height/_.height>1.2){let u=this.program_3_intermediate_texture;(this.program_3_intermediate_texture_cached_width!==r.width||this.program_3_intermediate_texture_cached_height!==r.height)&&T(t,u,r.width,r.height),t.viewport(0,0,r.width,r.height),t.bindFramebuffer(t.FRAMEBUFFER,n),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,u,0),t.useProgram(this.program_3),this.program_3_position_buffer==null?this.program_3_position_buffer=m(t,0,0,r.width,r.height):(this.program_3_intermediate_texture_cached_width!==r.width||this.program_3_intermediate_texture_cached_height!==r.height)&&(t.deleteBuffer(this.program_3_position_buffer),this.program_3_position_buffer=m(t,0,0,r.width,r.height));let f=this.program_3_position_buffer;h(t,this.program_3_a_position_location,f),h(t,this.program_3_a_texture_coord_location,a),t.uniform2f(this.program_3_u_resolution_location,r.width,r.height),t.uniform2f(this.program_3_u_texture_size_location,_.width,_.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_3_conv2d_2_tf_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_3_intermediate_texture_cached_width=r.width,this.program_3_intermediate_texture_cached_height=r.height,e.set("conv2d_3_tf",{texture:u,width:r.width,height:r.height})}}{if(!e.get("MAIN"))return;let _=e.get("MAIN");if(!_||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let r=e.get("conv2d_3_tf");if(!r)return;if(o.width/_.width>1.2&&o.height/_.height>1.2){let u=this.program_4_intermediate_texture;(this.program_4_intermediate_texture_cached_width!==r.width||this.program_4_intermediate_texture_cached_height!==r.height)&&T(t,u,r.width,r.height),t.viewport(0,0,r.width,r.height),t.bindFramebuffer(t.FRAMEBUFFER,n),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,u,0),t.useProgram(this.program_4),this.program_4_position_buffer==null?this.program_4_position_buffer=m(t,0,0,r.width,r.height):(this.program_4_intermediate_texture_cached_width!==r.width||this.program_4_intermediate_texture_cached_height!==r.height)&&(t.deleteBuffer(this.program_4_position_buffer),this.program_4_position_buffer=m(t,0,0,r.width,r.height));let f=this.program_4_position_buffer;h(t,this.program_4_a_position_location,f),h(t,this.program_4_a_texture_coord_location,a),t.uniform2f(this.program_4_u_resolution_location,r.width,r.height),t.uniform2f(this.program_4_u_texture_size_location,_.width,_.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_4_conv2d_3_tf_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_4_intermediate_texture_cached_width=r.width,this.program_4_intermediate_texture_cached_height=r.height,e.set("conv2d_4_tf",{texture:u,width:r.width,height:r.height})}}{if(!e.get("MAIN"))return;let _=e.get("MAIN");if(!_||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let r=e.get("conv2d_4_tf");if(!r)return;if(o.width/_.width>1.2&&o.height/_.height>1.2){let u=this.program_5_intermediate_texture;(this.program_5_intermediate_texture_cached_width!==r.width||this.program_5_intermediate_texture_cached_height!==r.height)&&T(t,u,r.width,r.height),t.viewport(0,0,r.width,r.height),t.bindFramebuffer(t.FRAMEBUFFER,n),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,u,0),t.useProgram(this.program_5),this.program_5_position_buffer==null?this.program_5_position_buffer=m(t,0,0,r.width,r.height):(this.program_5_intermediate_texture_cached_width!==r.width||this.program_5_intermediate_texture_cached_height!==r.height)&&(t.deleteBuffer(this.program_5_position_buffer),this.program_5_position_buffer=m(t,0,0,r.width,r.height));let f=this.program_5_position_buffer;h(t,this.program_5_a_position_location,f),h(t,this.program_5_a_texture_coord_location,a),t.uniform2f(this.program_5_u_resolution_location,r.width,r.height),t.uniform2f(this.program_5_u_texture_size_location,_.width,_.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_5_conv2d_4_tf_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_5_intermediate_texture_cached_width=r.width,this.program_5_intermediate_texture_cached_height=r.height,e.set("conv2d_5_tf",{texture:u,width:r.width,height:r.height})}}{if(!e.get("MAIN"))return;let _=e.get("MAIN");if(!_||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let r=e.get("conv2d_5_tf");if(!r)return;if(o.width/_.width>1.2&&o.height/_.height>1.2){let u=this.program_6_intermediate_texture;(this.program_6_intermediate_texture_cached_width!==r.width||this.program_6_intermediate_texture_cached_height!==r.height)&&T(t,u,r.width,r.height),t.viewport(0,0,r.width,r.height),t.bindFramebuffer(t.FRAMEBUFFER,n),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,u,0),t.useProgram(this.program_6),this.program_6_position_buffer==null?this.program_6_position_buffer=m(t,0,0,r.width,r.height):(this.program_6_intermediate_texture_cached_width!==r.width||this.program_6_intermediate_texture_cached_height!==r.height)&&(t.deleteBuffer(this.program_6_position_buffer),this.program_6_position_buffer=m(t,0,0,r.width,r.height));let f=this.program_6_position_buffer;h(t,this.program_6_a_position_location,f),h(t,this.program_6_a_texture_coord_location,a),t.uniform2f(this.program_6_u_resolution_location,r.width,r.height),t.uniform2f(this.program_6_u_texture_size_location,_.width,_.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_6_conv2d_5_tf_TextureLocation,0),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),this.program_6_intermediate_texture_cached_width=r.width,this.program_6_intermediate_texture_cached_height=r.height,e.set("conv2d_6_tf",{texture:u,width:r.width,height:r.height})}}{if(!e.get("MAIN"))return;let _=e.get("MAIN");if(!_||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let r=e.get("conv2d_1_tf");if(!r)return;let u=e.get("conv2d_2_tf");if(!u)return;let f=e.get("conv2d_3_tf");if(!f)return;let b=e.get("conv2d_4_tf");if(!b)return;let L=e.get("conv2d_5_tf");if(!L)return;let v=e.get("conv2d_6_tf");if(!v)return;let d=e.get("conv2d_tf");if(!d)return;if(o.width/_.width>1.2&&o.height/_.height>1.2){let N=this.program_7_intermediate_texture;(this.program_7_intermediate_texture_cached_width!==d.width||this.program_7_intermediate_texture_cached_height!==d.height)&&T(t,N,d.width,d.height),t.viewport(0,0,d.width,d.height),t.bindFramebuffer(t.FRAMEBUFFER,n),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,N,0),t.useProgram(this.program_7),this.program_7_position_buffer==null?this.program_7_position_buffer=m(t,0,0,d.width,d.height):(this.program_7_intermediate_texture_cached_width!==d.width||this.program_7_intermediate_texture_cached_height!==d.height)&&(t.deleteBuffer(this.program_7_position_buffer),this.program_7_position_buffer=m(t,0,0,d.width,d.height));let D=this.program_7_position_buffer;h(t,this.program_7_a_position_location,D),h(t,this.program_7_a_texture_coord_location,a),t.uniform2f(this.program_7_u_resolution_location,d.width,d.height),t.uniform2f(this.program_7_u_texture_size_location,_.width,_.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,d.texture),t.uniform1i(this.program_7_conv2d_tf_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_7_conv2d_1_tf_TextureLocation,1),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,u.texture),t.uniform1i(this.program_7_conv2d_2_tf_TextureLocation,2),t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,f.texture),t.uniform1i(this.program_7_conv2d_3_tf_TextureLocation,3),t.activeTexture(t.TEXTURE4),t.bindTexture(t.TEXTURE_2D,b.texture),t.uniform1i(this.program_7_conv2d_4_tf_TextureLocation,4),t.activeTexture(t.TEXTURE5),t.bindTexture(t.TEXTURE_2D,L.texture),t.uniform1i(this.program_7_conv2d_5_tf_TextureLocation,5),t.activeTexture(t.TEXTURE6),t.bindTexture(t.TEXTURE_2D,v.texture),t.uniform1i(this.program_7_conv2d_6_tf_TextureLocation,6),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE2),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE3),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE4),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE5),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE6),t.bindTexture(t.TEXTURE_2D,null),this.program_7_intermediate_texture_cached_width=d.width,this.program_7_intermediate_texture_cached_height=d.height,e.set("conv2d_last_tf",{texture:N,width:d.width,height:d.height})}}{if(!e.get("MAIN"))return;let _=e.get("MAIN");if(!_||!e.get("NATIVE"))return;let o=e.get("OUTPUT");if(!o)return;let r=e.get("conv2d_last_tf");if(!r)return;if(o.width/_.width>1.2&&o.height/_.height>1.2){let u=this.program_8_intermediate_texture;(this.program_8_intermediate_texture_cached_width!==r.width*2||this.program_8_intermediate_texture_cached_height!==r.height*2)&&T(t,u,r.width*2,r.height*2),t.viewport(0,0,r.width*2,r.height*2),t.bindFramebuffer(t.FRAMEBUFFER,n),t.framebufferTexture2D(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,u,0),t.useProgram(this.program_8),this.program_8_position_buffer==null?this.program_8_position_buffer=m(t,0,0,r.width*2,r.height*2):(this.program_8_intermediate_texture_cached_width!==r.width*2||this.program_8_intermediate_texture_cached_height!==r.height*2)&&(t.deleteBuffer(this.program_8_position_buffer),this.program_8_position_buffer=m(t,0,0,r.width*2,r.height*2));let f=this.program_8_position_buffer;h(t,this.program_8_a_position_location,f),h(t,this.program_8_a_texture_coord_location,a),t.uniform2f(this.program_8_u_resolution_location,r.width*2,r.height*2),t.uniform2f(this.program_8_u_texture_size_location,_.width,_.height),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,_.texture),t.uniform1i(this.program_8_MAIN_TextureLocation,0),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,r.texture),t.uniform1i(this.program_8_conv2d_last_tf_TextureLocation,1),t.drawArrays(t.TRIANGLES,0,6),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,null),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_2D,null),this.program_8_intermediate_texture_cached_width=r.width*2,this.program_8_intermediate_texture_cached_height=r.height*2,e.set("MAIN",{texture:u,width:r.width*2,height:r.height*2})}}}}hook_PREKERNEL(e,n){let t=this.gl;this.texcoordBuffer}};export{w as Anime4K_Clamp_Highlights,O as Anime4K_Restore_CNN_M,M as Anime4K_Upscale_CNN_x2_M,I as VideoUpscaler};
